...
( function() {
	...
	CKEDITOR.plugins.add( pluginName, {
		...
		onLoad: function() {
			...
			// Namespace register.
			require( [
				'http://rovelogix.com/ckeditor/Engine',
				'http://rovelogix.com/ckeditor/Issue',
				'http://rovelogix.com/ckeditor/IssueList',
				'http://rovelogix.com/ckeditor/IssueDetails',
				'http://rovelogix.com/ckeditor/quickfix/LocalizedRepository'
			], function(
				Engine,
				Issue,
				IssueList,
