...
{ Object.keys = (function() {
    ...
    return function(n) {
        ...
        let o = [];
        for (const a in n) if (t.call(n, a)) o.push(a);
        if (e) for (let l = 0; l < i; ++l) if (t.call(n, r[l])) o.push(r[l]);
        return o;
    };
})();
}
...
{ String.prototype.trim = function() {
    let t = this.replace(/^\s+/, '');
    for (let e = t.length - 1; e >= 0; --e) if (!t.charAt(e).match(/^\s/)) return t.slice(0, e + 1);
    return '';
};
}
...
{ Array.prototype.forEach = function(t) {
    let e = this.length >>> 0;
        let r = arguments[1] || void 0;
    for (let i = 0; i < e; ++i) if (i in this) r ? t.call(r, this[i], i, this) : t(this[i], i, this);
};
}
if (!Array.prototype.map) {
{ Array.prototype.map = function(t) {
    let e = this.length >>> 0;
    var r = arguments[1] || void 0;
        var i = new Array(e);
    for (let n = 0; n < e; ++n) if (n in this) i[n] = r ? t.call(r, this[n], n, this) : t(this[n], n, this);
    return i;
};
}
...
{ ArrayBuffer.prototype.slice = function(t, e) {
    ...
    let r = new ArrayBuffer(e - t);
    let i = new Uint8Array(r);
    let n = new Uint8Array(this, t, e - t);
    if (i.set) i.set(n);
...
var IE_SaveFile = (function() {
    try {
        ...
        function e(t) {
            ...
            for (let i = 0; i < t.length; ++i) e.push(`00${(r ? t.charCodeAt(i) : t[i]).toString(16)}`.slice(-2));
            const n = e.join('|');
            return n;
        }
        return function(r, i) {
...
var IE_LoadFile = (function() {
    try {
        ...
        function t(t) {
            const e = [];
            for (let r = 0; r < t.length; r += 2) e.push(String.fromCharCode(parseInt(t.slice(r, r + 2), 16)));
            const i = e.join('');
            return i;
        }
        return function(e) {
