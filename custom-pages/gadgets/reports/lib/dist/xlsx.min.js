...
function make_xlsx_lib(e) {
    ...
    var V = (function Qm() {
        ...
        function Ie(e, r, t, a, n) {
            ...
            var S = W.buf(g, 0);
            if (c >> 0 != S >> 0) Te(E, 'Bad CRC32 checksum: ' + c + ' != ' + S);
    ...
    function Ce(e, r) {
        ...
        switch (r.type) {
            case 'base64':
                t = new Be(e, { base64: true });
                break;
            case 'binary':
            case 'array':
                t = new Be(e, { base64: false });
                break;
            case 'buffer':
                t = new Be(e);
                break;
            ...
            case 'dbcs-cont':
                ...
                for (o = 0; o < e; ++o) {
                    if (this.lens && this.lens.indexOf(c) !== -1) {
                        f = Pr(this, c);
                        this.l = c + 1;
                        l = Wr.call(this, e - o, f ? 'dbcs-cont' : 'sbcs-cont');
                        return s.join('') + l;
                    }
                    s.push(v(Nr(this, c)));
                    c += 2;
    ...
    function zr(e, r, t) {
        var a = 0,
            n = 0;
        if (t === 'dbcs') {
            for (n = 0; n != r.length; ++n) Gr(this, r.charCodeAt(n), this.l + 2 * n);
            a = 2 * r.length;
        } else if (t === 'sbcs') {
    ...
    function vt(e) {
        var r = dt(e);
        return { c: ot(r[0]), r: it(r[1]) };
    }
    function pt(e) {
        return ct(e.c) + st(e.r);
    }
    function mt(e) {
        var r = e.split(':').map(vt);
    ...
    var ga = {
        ...
        11: { n: 'ScaleCrop', t: fa },
        12: { n: 'HeadingPairs', t: va | la },
        13: { n: 'TitlesOfParts', t: va | ca },
        14: { n: 'Manager', t: pa },
        15: { n: 'Company', t: pa },
        ...
        24: { n: 'DigSig', t: ha },
        26: { n: 'ContentType', t: pa },
        27: { n: 'ContentStatus', t: pa },
        28: { n: 'Language', t: pa },
        29: { n: 'Version', t: pa },
        255: {}
    };
    var Ea = {
        ...
        9: { n: 'RevNumber', t: pa },
        10: { n: 'EditTime', t: ua },
        11: { n: 'LastPrinted', t: ua },
        12: { n: 'CreatedDate', t: ua },
        13: { n: 'ModifiedDate', t: ua },
        14: { n: 'PageCount', t: sa },
        15: { n: 'WordCount', t: sa },
        16: { n: 'CharCount', t: sa },
        17: { n: 'Thumbnail', t: da },
        18: { n: 'Application', t: pa },
        19: { n: 'DocSecurity', t: sa },
        255: {}
    };
    var Sa = {
        2147483648: { n: 'Locale', t: oa },
        2147483651: { n: 'Behavior', t: oa },
        1919054434: {}
    };
    (function() {
        for (var e in Sa) if (Sa.hasOwnProperty(e)) ga[e] = Ea[e] = Sa[e];
    })();
    var ka = Y(ga, 'n');
    var wa = Y(Ea, 'n');
    var Ca = {
    ...
    var La = fr('Relationships', null, { xmlns: cr.RELS });
    function Ua(e) {
        var r = [Ie, La];
    ...
    function ja(e) {
        ...
        for (var t = 0; t != e.length; ++t) {
            r.push(Ga(e[t][0], e[t][1]));
            r.push(za('', e[t][0]));
        }
        r.push(Ga('', 'Document', 'pkg'));
        r.push('</rdf:RDF>');
        return r.join('');
    }
    var Ka = (function() {
    ...
    var Ja = fr('cp:coreProperties', null, {
    ...
    function qa(e, r) {
        ...
        if (e) {
            if (e.CreatedDate != null) Za('dcterms:created', typeof e.CreatedDate === 'string' ? e.CreatedDate : lr(e.CreatedDate, t.WTF), { 'xsi:type': 'dcterms:W3CDTF' }, a, n);
            if (e.ModifiedDate != null) Za('dcterms:modified', typeof e.ModifiedDate === 'string' ? e.ModifiedDate : lr(e.ModifiedDate, t.WTF), { 'xsi:type': 'dcterms:W3CDTF' }, a, n);
        }
    ...
    var on = fr('Properties', null, { xmlns: cr.CUST_PROPS, 'xmlns:vt': cr.vt });
    function cn(e) {
        var r = [Ie, on];
        if (!e) return r.join('');
        var t = 1;
    ...
    function vn(e, r) {
        ...
        K(un)
            .map(function(e) {
                for (var r = 0; r < $a.length; ++r) if ($a[r][1] == e) return $a[r];
    ...
    function yn(e, r, t) {
        var a = e._R(2),
            ...
            i = t || {};
        e.l += 2;
        if (r !== la) if (a !== r && ba.indexOf(r) === -1) throw new Error('Expected type ' + r + ' saw ' + a);
        switch (r === la ? a : r) {
            case 2:
                n = e._R(2, 'i');
                if (!i.raw) e.l += 2;
            ...
            case 71:
                return Rn(e);
            case 80:
                return kn(e, a, !i.raw).replace(y, '');
            case 81:
                return wn(e, a).replace(y, '');
            case 4108:
                return In(e);
            case 4126:
                return Bn(e);
    ...
    function bs(e, r, t) {
        ...
        var o = Jn(e, s, t);
        if (n & 32) o = ms[o.charCodeAt(0)];
        var c = a - e.l;
        if (t && t.biff == 2) --c;
        var u = a == e.l || f === 0 ? [] : Fu(e, c, t, f);
    ...
    function gs(e, r, t) {
        ...
        var a = [],
            n = e.l + r,
            i = e._R(t.biff > 8 ? 4 : 2);
        while (i-- !== 0) a.push(vi(e, t.biff > 8 ? 12 : 6, t));
    ...
    function Is(e) {
        ...
        r._W(2, e.length);
        for (var t = 0; t < e.length; ++t) gi(e[t], r);
        return r;
    }
    function As(e, r, t) {
        if (t && t.biff < 8) return Rs(e, r, t);
        var a = ki(e, 22);
        var n = xi(e, r - 22, a[1]);
        return { cmo: a, ft: n };
    }
    ...
    function ys(e, r, t) {
        ...
        try {
            ...
            for (var o = 1; o < e.lens.length - 1; ++o) {
                ...
                var c = e[e.l];
                var u = Jn(e, e.lens[o + 1] - e.lens[o] - 1);
                n += u;
    ...
    var af = (function() {
        ...
        function f(e, a) {
            ...
            var i = Jr();
            var f = Om(e, { header: 1, raw: true, cellDates: true });
            var o = f[0],
                c = f.slice(1);
            var u = 0,
                h = 0,
        ...
        function c(e, r) {
            r.forEach(function(r, t) {
                ...
                if (r.hidden) a += '0';
                    ...
                    if (typeof r.width == 'number') r.wpx = sl(r.width);
                    if (typeof r.wpx == 'number') r.wch = fl(r.wpx);
    ...
    var lf = (function() {
        ...
        function f(e, r) {
            var t = '',
                a = r.type == 'string' ? [0, 0, 0, 0] : dm(e, r);
            switch (r.type) {
                case 'base64':
                    t = g.decode(e);
                    break;
    ...
    function pf(e, r) {
        ...
        if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
            ...
            a.r = Ke(e);
            a.t = Ne(Ke((e.replace(vf, '').match(hf) || []).join('').replace(_e, '')));
            if (t) a.h = uf(a.r);
        }
        return a;
    }
    var mf = /<(?:\w+:)?sst([^>]*)>([\s\S]*)<\/(?:\w+:)?sst>/;
    var bf = /<(?:\w+:)?(?:si|sstItem)>/g;
    var gf = /<\/(?:\w+:)?(?:si|sstItem)>/;
    function Ef(e, r) {
        var t = [],
            a = '';
    ...
    function kf(e, r) {
        ...
        for (var a = 0; a != e.length; ++a) {
            ...
            if (n.r) i += n.r;
                ...
                i += '<t';
                if (!n.t) n.t = '';
                if (n.t.match(Sf)) i += ' xml:space="preserve"';
                i += '>' + Ue(n.t) + '</t>';
            }
            i += '</si>';
            t[t.length] = i;
    ...
    function xf(e) {
        var r = Jr();
        Zr(r, 'BrtBeginSst', Bf(e));
        for (var t = 0; t < e.length; ++t) Zr(r, 'BrtSSTItem', Tf(e[t]));
        Zr(r, 'BrtEndSst');
        return r.end();
    }
    function If(e) {
    ...
    function Kf(e, r, t, a) {
        var n = { key: Gn(e), verificationBytes: Gn(e) };
        if (t.password) n.verifier = Xf(t.password);
    ...
    var tl = 6,
        ...
        il = tl;
    function sl(e) {
        return Math.floor((e + Math.round(128 / il) / 256) * il);
    }
    function fl(e) {
        return Math.floor(((e - 5) / il) * 100 + 0.5) / 100;
    }
    function ll(e) {
        return Math.round(((e * il + 5) / il) * 256) / 256;
    }
    function ol(e) {
        return ll(fl(sl(e)));
    }
                ...
                case '<color':
                    ...
                    if (f.rgb) n.color.rgb = f.rgb.slice(-6);
                        ...
                        if (f.theme && t.themeElements && t.themeElements.clrScheme) {
                            n.color.rgb = rl(t.themeElements.clrScheme[n.color.theme].rgb, n.color.tint || 0);
                        }
                    }
                    break;
                case '<color/>':
    ...
    var wl = ['numFmtId', 'fillId', 'fontId', 'borderId', 'xfId'];
    var Cl = ['applyAlignment', 'applyBorder', 'applyFill', 'applyFont', 'applyNumberFormat', 'applyProtection', 'pivotButton', 'quotePrefix'];
    function Bl(e, r, t) {
        r.CellXf = [];
        var a;
        var n = false;
        e[0].match(_e).forEach(function(e) {
            ...
            switch (De(i[0])) {
                ...
                case '<xf/>':
                    a = i;
                    delete a[0];
                    for (s = 0; s < wl.length; ++s) if (a[wl[s]]) a[wl[s]] = parseInt(a[wl[s]], 10);
                    for (s = 0; s < Cl.length; ++s) if (a[Cl[s]]) a[Cl[s]] = je(a[Cl[s]]);
                    if (a.numFmtId > 392) {
                        for (s = 392; s > 60; --s)
    ...
    var xl = (function ub() {
        ...
        return function i(s, f, l) {
            ...
            var c;
            if ((c = s.match(e))) Sl(c, o, l);
            if ((c = s.match(a))) El(c, o, f, l);
            if ((c = s.match(t))) gl(c, o, f, l);
            if ((c = s.match(n))) bl(c, o, f, l);
            if ((c = s.match(r))) Bl(c, o, l);
            return o;
        };
    })();
    var Il = fr('styleSheet', null, { xmlns: cr.main[0], 'xmlns:vt': cr.vt });
    Pa.STY = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles';
    function Al(e, r) {
        var t = [Ie, Il],
            a;
        if (e.SSF && (a = kl(e.SSF)) != null) t[t.length] = a;
        ...
        if ((a = Tl(r.cellXfs))) t[t.length] = a;
            ...
            switch (l) {
                ...
                case 43:
                    ...
                    if (e.color.theme != null && r && r.themeElements && r.themeElements.clrScheme) {
                        e.color.rgb = rl(r.themeElements.clrScheme[e.color.theme].rgb, e.color.tint || 0);
                    }
                    break;
                case 1025:
                    break;
    ...
    function zl(e, r) {
        ...
        [
            ...
            for (var a = t[0]; a <= t[1]; ++a) if (r[a] != null) Zr(e, 'BrtFmt', Rl(a, r[a]));
        });
        Zr(e, 'BrtEndFmts');
    }
    function jl(e) {
    ...
    function Kl(e) {
        ...
        Zr(e, 'BrtFill', Nl({ patternType: 'none' }));
        Zr(e, 'BrtFill', Nl({ patternType: 'gray125' }));
        Zr(e, 'BrtEndFills');
    }
    function $l(e) {
        var r = 1;
    ...
    function Yl(e) {
        ...
        Zr(e, 'BrtXF', Ll({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535));
    ...
    function Jl(e) {
        ...
        Zr(e, 'BrtStyle', Vl({ xfId: 0, builtinId: 0, name: 'Normal' }));
        Zr(e, 'BrtEndStyles');
    }
    function Zl(e) {
        var r = 0;
    ...
    function ql(e) {
        var r = 0;
        Zr(e, 'BrtBeginTableStyles', Xl(r, 'TableStyleMedium9', 'PivotStyleMedium4'));
    ...
    function ao() {}
    function no() {}
    var io = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
    var so = /<a:fontScheme([^>]*)>[\s\S]*<\/a:fontScheme>/;
    var fo = /<a:fmtScheme([^>]*)>[\s\S]*<\/a:fmtScheme>/;
    function lo(e, r, t) {
        r.themeElements = {};
        var a;
        [
    ...
    var oo = /<a:themeElements([^>]*)>[\s\S]*<\/a:themeElements>/;
    function co(e, r) {
        if (!e || e.length === 0) return co(uo());
        var t;
        var a = {};
        if (!(t = e.match(oo))) throw new Error('themeElements not found in theme');
        lo(t[0], a, r);
        return a;
    }
    function uo(e, r) {
    ...
    function Ao(e, r) {
        ...
        var n = [
            ...
            fr('v:shapetype', [fr('v:stroke', null, { joinstyle: 'miter' }), fr('v:path', null, { gradientshapeok: 't', 'o:connecttype': 'rect' })].join(''), { id: '_x0000_t202', 'o:spt': 202, coordsize: t.join(','), path: a })
        ];
        while (Io < e * 1e3) Io += 1e3;
        r.forEach(function(e) {
            var r = vt(e[0]);
            n = n.concat([
                '<v:shape' +
                    ...
                    '>',
                fr('v:fill', fr('o:fill', null, { type: 'gradientUnscaled', 'v:ext': 'view' }), { color2: '#BEFF82', angle: '-180', type: 'gradient' }),
    ...
    function _o(e, r, t, a, n) {
        for (var i = 0; i != r.length; ++i) {
            var s = r[i];
            var f = wv(Ee(e, s.replace(/^\//, ''), true), s, n);
    ...
    function Ro(e, r, t) {
        ...
        t.forEach(function(e) {
            ...
            if (!n) {
                ...
                var i = gt(r['!ref'] || 'BDWGO1000001:A1');
    ...
    var Fo = fr('comments', null, { xmlns: cr.main[0] });
    function Do(e) {
        var r = [Ie, Fo];
        var t = [];
        r.push('<authors>');
    ...
    var Ho = 'application/vnd.ms-office.vbaProject';
    function Wo(e) {
    ...
    var Xo = ['xlsb', 'xlsm', 'xlam', 'biff8', 'xla'];
    ...
    var Yo = /(^|[^._A-Z0-9])([$]?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])([$]?)([1-9]\d{0,5}|10[0-3]\d{4}|104[0-7]\d{3}|1048[0-4]\d{2}|10485[0-6]\d|104857[0-6])(?![_.\(A-Za-z0-9])/g;
    var Qo = (function() {
        return function e(r, t) {
            return r.replace(Yo, function(e, r, a, n, i, s) {
                var f = ot(n) - (a ? 0 : t.c);
                var l = it(s) - (i ? 0 : t.r);
                var o = l == 0 ? '' : !i ? '[' + l + ']' : l + 1;
                var c = f == 0 ? '' : !a ? '[' + f + ']' : f + 1;
    ...
    function Jo(e, r) {
        return e.replace(Yo, function(e, t, a, n, i, s) {
            return t + (a == '$' ? a + n : ct(ot(n) + r.c)) + (i == '$' ? i + s : st(it(s) + r.r));
        });
    }
    function Zo(e, r, t) {
        var a = mt(r),
    ...
    function Hc(e, r, t) {
        var a = e._R(t.biff == 12 ? 4 : 2);
        var n = [];
        for (var i = 0; i != a; ++i) n.push((t.biff == 12 ? jt : bi)(e, 8));
        return n;
    }
    function Wc(e, r, t) {
        var a = 0,
        ...
        for (var i = 0, s = []; i != a && (s[i] = []); ++i) for (var f = 0; f != n; ++f) s[i][f] = Uc(e, t.biff);
        return s;
    }
    function Vc(e, r, t) {
        var a = (e._R(1) >>> 5) & 3;
    ...
    var lu = Zc;
    var ou = Zc;
    var cu = ['Data', 'All', 'Headers', '??', '?Data2', '??', '?DataHeaders', '??', 'Totals', '??', '??', '??', '?DataTotals', '??', '??', '??', '?Current'];
    function uu(e) {
        e.l += 2;
        var r = e._R(2);
        var t = e._R(2);
    ...
    var gu = {
        ...
        47: { n: 'PtgMemNoMemN', f: mu },
        57: { n: 'PtgNameX', f: Xc },
        58: { n: 'PtgRef3d', f: Ac },
        59: { n: 'PtgArea3d', f: hc },
        60: { n: 'PtgRefErr3d', f: $c },
        61: { n: 'PtgAreaErr3d', f: vc },
        255: {}
    };
    var Eu = {
        64: 32,
    ...
    var Su = {
        ...
        6: { n: 'PtgElfRwV', f: ou },
        7: { n: 'PtgElfColV', f: au },
        10: { n: 'PtgElfRadical', f: iu },
        11: { n: 'PtgElfRadicalS', f: fu },
        13: { n: 'PtgElfColS', f: ru },
        15: { n: 'PtgElfColSV', f: tu },
        16: { n: 'PtgElfRadicalLel', f: su },
        25: { n: 'PtgList', f: uu },
        29: { n: 'PtgSxName', f: hu },
        255: {}
    };
    var ku = {
        0: { n: 'PtgAttrNoop', f: bu },
        1: { n: 'PtgAttrSemi', f: wc },
        2: { n: 'PtgAttrIf', f: Sc },
        4: { n: 'PtgAttrChoose', f: gc },
        8: { n: 'PtgAttrGoto', f: Ec },
        16: { n: 'PtgAttrSum', f: Fc },
        32: { n: 'PtgAttrBaxcel', f: bc },
        64: { n: 'PtgAttrSpace', f: Bc },
        65: { n: 'PtgAttrSpaceSemi', f: Tc },
        128: { n: 'PtgAttrIfError', f: kc },
        255: {}
    };
    ku[33] = ku[32];
    function wu(e, r, t, a) {
    ...
    function Cu(e, r, t) {
        ...
        while (a != e.l) {
            ...
            i = e[e.l];
            n = gu[i];
            if (i === 24 || i === 25) n = (i === 24 ? Su : ku)[e[e.l + 1]];
            if (!n || !n.f) {
                $r(e, r);
            } else {
    ...
    function Ru(e, r, t) {
        ...
        var i,
            s = e._R(n);
        if (s == 65535) return [[], $r(e, r - 2)];
        var f = Cu(e, s, t);
        if (r !== s + n) i = wu(e, r - s - n, f, t);
        e.l = a;
        return [f, i];
    }
    function yu(e, r, t) {
    ...
    function Du(e, r, t) {
        ...
        var n,
            i = e._R(2);
        var s = Cu(e, i, t);
        if (i == 65535) return [[], $r(e, r - 2)];
        if (r !== i + 2) n = wu(e, a - i - 2, s, t);
        return [s, n];
    }
    function Ou(e) {
        var r;
    ...
    function ju(e) {
        var r = 'of:=' + e.replace(Yo, '$1[.$2$3$4$5]').replace(/\]:\[/g, ':');
        ...
        if (!a || a.cellText !== false)
            try {
                ...
                if (e.t === 'e') e.w = e.w || Qt[e.v];
                    ...
                    else e.w = D._general(e.v, Qu);
                } else if (e.t === 'd') e.w = D.format(r, re(e.v), Qu);
                else e.w = D.format(r, e.v, Qu);
            } catch (s) {
                if (a.WTF) throw s;
            }
        ...
        if (t != null)
            try {
                ...
                if (e.s.fgColor && e.s.fgColor.theme && !e.s.fgColor.rgb) {
                    e.s.fgColor.rgb = rl(n.themeElements.clrScheme[e.s.fgColor.theme].rgb, e.s.fgColor.tint || 0);
                    if (a.WTF) e.s.fgColor.raw_rgb = n.themeElements.clrScheme[e.s.fgColor.theme].rgb;
                }
                if (e.s.bgColor && e.s.bgColor.theme) {
                    e.s.bgColor.rgb = rl(n.themeElements.clrScheme[e.s.bgColor.theme].rgb, e.s.bgColor.tint || 0);
    ...
    function nh(e, r) {
        var t = gt(r);
        if (t.s.r <= t.e.r && t.s.c <= t.e.c && t.s.r >= 0 && t.s.c >= 0) e['!ref'] = bt(t);
    }
    var ih = /<(?:\w:)?mergeCell ref="[A-Z0-9:]+"\s*[\/]?>/g;
    var sh = /<(?:\w+:)?sheetData>([\s\S]*)<\/(?:\w+:)?sheetData>/;
    var fh = /<(?:\w:)?hyperlink [^>]*>/gm;
    var lh = /"(\w*:\w*)"/;
    var oh = /<(?:\w:)?col\b[^>]*[\/]?>/g;
    var ch = /<(?:\w:)?autoFilter[^>]*([\/]|>([\s\S]*)<\/(?:\w:)?autoFilter)>/g;
    var uh = /<(?:\w:)?pageMargins[^>]*\/>/g;
    var hh = /<(?:\w:)?sheetPr\b(?:[^>a-z][^>]*)?\/>/;
    var dh = /<(?:\w:)?sheetViews[^>]*(?:[\/]|>([\s\S]*)<\/(?:\w:)?sheetViews)>/;
    function vh(e, r, t, a, n, i, s) {
        ...
        var E = c.match(ch);
        if (E) f['!autofilter'] = Ch(E[0]);
        var S = [];
        var k = c.match(ih);
        if (k) for (d = 0; d != k.length; ++d) S[d] = gt(k[d].slice(k[d].indexOf('"') + 1));
        var w = c.match(fh);
        if (w) gh(f, w, a);
        var C = c.match(uh);
        if (C) f['!margins'] = Eh(Fe(C[0]));
        if (!f['!ref'] && l.e.c >= l.s.c && l.e.r >= l.s.r) f['!ref'] = bt(l);
    ...
    function ph(e) {
        ...
        for (var t = 0; t != e.length; ++t) r += '<mergeCell ref="' + bt(e[t]) + '"/>';
        return r + '</mergeCells>';
    }
    function mh(e, r, t, a) {
        var n = Fe(e);
    ...
    var Th = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/>/;
    function xh(e, r) {
        (e.match(Th) || []).forEach(function(e) {
            var t = Fe(e);
            if (je(t.rightToLeft)) {
                if (!r.Views) r.Views = [{}];
    ...
    function Ah(e, r, t, a) {
        ...
        switch (e.t) {
            ...
            default:
                ...
                if (a.bookSST) {
                    f = ir('v', '' + Zu(a.Strings, e.v, a.revStrings));
                    l.t = 's';
                    break;
                }
                l.t = 'str';
        ...
        return function f(l, o, c, u, h, d) {
            ...
            for (var U = l.split(r), H = 0, W = U.length; H != W; ++H) {
                ...
                for (v = 0; v != m.length; ++v) {
                    ...
                    k = p.slice(E);
                    w = { t: '' };
                    if ((b = k.match(i)) != null && b[1] !== '') w.v = Ne(b[1]);
                    if (c.cellFormula) {
                        if ((b = k.match(s)) != null && b[1] !== '') {
                            w.f = ec(Ne(Ke(b[1])));
                            if (b[0].indexOf('t="array"') > -1) {
                                w.F = (k.match(n) || [])[1];
                                if (w.F.indexOf(':') > -1) F.push([gt(w.F), w.F]);
                            } else if (b[0].indexOf('t="shared"') > -1) {
                                I = Fe(b[0]);
                                O[parseInt(I.si, 10)] = [I, ec(Ne(Ke(b[1]))), C.r];
                            }
                        } else if ((b = k.match(/<f[^>]*\/>/))) {
                            I = Fe(b[0]);
                            if (O[I.si]) w.f = Zo(O[I.si][1], O[I.si][2], C.r);
                        }
                        var X = vt(C.r);
                    ...
                    switch (w.t) {
                        ...
                        case 'str':
                            w.t = 's';
                            w.v = w.v != null ? Ke(w.v) : '';
                            if (c.cellHTML) w.h = Ve(w.v);
                            break;
                        case 'inlineStr':
                            b = k.match(a);
                            w.t = 's';
                            if (b != null && (x = pf(b[1]))) w.v = x.t;
                            else w.v = '';
                            break;
                        case 'b':
                            w.v = je(w.v);
    ...
    function Rh(e, r, t, a) {
        ...
        var p = { r: o },
            m,
            b = -1;
        for (h = s.s.c; h <= s.e.c; ++h) c[h] = ct(h);
        for (u = s.s.r; u <= s.e.r; ++u) {
            ...
            for (h = s.s.c; h <= s.e.c; ++h) {
                ...
                if ((f = Ah(g, l, e, r, t, a)) != null) i.push(f);
            }
            if (i.length > 0 || (d && d[u])) {
                p = { r: o };
                if (d && d[u]) {
    ...
    var yh = fr('worksheet', null, { xmlns: cr.main[0], 'xmlns:r': cr.r });
    function Fh(e, r, t, a) {
        var n = [Ie, yh];
        ...
        if (r.bookType !== 'xlsx' && t.vbaraw) {
            ...
            n[n.length] = fr('sheetPr', null, { codeName: Ue(u) });
        }
        n[n.length] = fr('dimension', null, { ref: o });
        n[n.length] = Ih(l, r, e, t);
        if (r.sheetFormat)
        ...
        if (l['!cols'] != null && l['!cols'].length > 0) n[n.length] = wh(l, l['!cols']);
        ...
        if (l['!protect'] != null) n[n.length] = bh(l['!protect']);
        if (l['!autofilter'] != null) n[n.length] = Bh(l['!autofilter'], l, t, e);
        if (l['!merges'] != null && l['!merges'].length > 0) n[n.length] = ph(l['!merges']);
        var d = -1,
            v,
            p = -1;
        if (l['!links'].length > 0) {
            ...
            l['!links'].forEach(function(e) {
                ...
                if (e[1].Target.charAt(0) != '#') {
                    p = Ha(a, -1, Ue(e[1].Target).replace(/#.*$/, ''), Pa.HLINK);
                    v['r:id'] = 'rId' + p;
                }
                if ((d = e[1].Target.indexOf('#')) > -1) v.location = Ue(e[1].Target.slice(d + 1));
                if (e[1].Tooltip) v.tooltip = Ue(e[1].Tooltip);
                n[n.length] = fr('hyperlink', null, v);
            });
            n[n.length] = '</hyperlinks>';
        }
        delete l['!links'];
        if (l['!margins'] != null) n[n.length] = Sh(l['!margins']);
        n[n.length] = '';
        if (!r || r.ignoreEC || r.ignoreEC == void 0) n[n.length] = ir('ignoredErrors', fr('ignoredError', null, { numberStoredAsText: 1, sqref: o }));
        if (l['!drawing'].length > 0) {
            p = Ha(a, -1, '../drawings/drawing' + (e + 1) + '.xml', Pa.DRAW);
            n[n.length] = fr('drawing', null, { 'r:id': 'rId' + p });
        } else delete l['!drawing'];
        if (l['!comments'].length > 0) {
            p = Ha(a, -1, '../drawings/vmlDrawing' + (e + 1) + '.vml', Pa.VML);
    ...
    function Oh(e, r, t) {
        ...
        for (var c = 0; c < 16; ++c) {
            ...
            for (var d = c << 10; d < (c + 1) << 10; ++d) {
                o.c = d;
                var v = Array.isArray(t) ? (t[o.r] || [])[o.c] : t[pt(o)];
                if (v) {
                    if (u < 0) u = d;
                    h = d;
                }
    ...
    function Ph(e, r, t, a) {
        var n = Oh(a, t, r);
        if (n.length > 17 || (r['!rows'] || [])[a]) Zr(e, 'BrtRowHdr', n);
    }
    var Nh = jt;
    var Mh = Kt;
    function Lh() {}
    ...
    var hd = ['left', 'right', 'top', 'bottom', 'header', 'footer'];
    function dd(e) {
        var r = {};
    ...
    function gd(e, r) {
        ...
        r._W(2, e.password ? Xf(e.password) : 0);
        r._W(4, 1);
        [
            ['objects', false],
            ['scenarios', false],
    ...
    function Ed(e, r, t, a, n, i, s) {
            ...
            function P(e, r, m) {
                ...
                switch (m) {
                    ...
                    case 11:
                        ...
                        if ((p = s.CellXf[e[0].iStyleRef])) th(v, p.numFmtId, null, f, i, s);
                        g = e[0].c;
                        if (f.dense) {
                            if (!l[b]) l[b] = [];
                            l[b][g] = v;
                    ...
                    case 426:
                        ...
                        x.push(e);
                        w = f.dense ? l[b][g] : l[ct(g) + k];
                        w.f = _u(e[1], c, { r: d.r, c: g }, A, f);
                        w.F = bt(e[0]);
                        break;
                    case 427:
                        if (!f.cellFormula) break;
        ...
        delete f.supbooks;
        delete f['!row'];
        if (!l['!ref'] && (c.s.r < 2e6 || (o && (o.e.r > 0 || o.e.c > 0 || o.s.r > 0 || o.s.c > 0)))) l['!ref'] = bt(o || c);
    ...
    function Sd(e, r, t, a, n, i) {
        ...
        switch (r.t) {
            ...
            case 'str':
                if (n.bookSST) {
                    s = Zu(n.Strings, r.v, n.revStrings);
                    f.t = 's';
                    f.v = s;
                    Zr(e, 'BrtCellIsst', Kh(r, f));
                } else {
                    f.t = 'str';
                    Zr(e, 'BrtCellSt', qh(r, f));
                }
                return;
            case 'n':
                if (r.v == (r.v | 0) && r.v > -1e3 && r.v < 1e3) Zr(e, 'BrtCellRk', Jh(r, f));
                else Zr(e, 'BrtCellReal', Yh(r, f));
                return;
            case 'b':
                f.t = 'b';
                Zr(e, 'BrtCellBool', Gh(r, f));
                return;
            case 'e':
                f.t = 'e';
                break;
        }
        Zr(e, 'BrtCellBlank', Vh(r, f));
    }
    function kd(e, r, t, a) {
        var n = gt(r['!ref'] || 'A1'),
            i,
    ...
    function wd(e, r) {
        ...
        Zr(e, 'BrtBeginMergeCells', sd(r['!merges'].length));
        r['!merges'].forEach(function(r) {
            Zr(e, 'BrtMergeCell', id(r));
        });
    ...
    function Bd(e, r) {
        ...
        Zr(e, 'BrtCellIgnoreEC', bd(gt(r['!ref'])));
    ...
    function Id(e, r) {
        ...
        Zr(e, 'BrtBeginAFilter', Kt(gt(r['!autofilter'].ref)));
        Zr(e, 'BrtEndAFilter');
    }
    function Ad(e, r, t) {
        Zr(e, 'BrtBeginWsViews');
        {
            Zr(e, 'BrtBeginWsView', md(r, t));
            Zr(e, 'BrtEndWsView');
        }
        Zr(e, 'BrtEndWsViews');
    }
    ...
    function Rd(e, r) {
        if (!r['!protect']) return;
        Zr(e, 'BrtSheetProtection', gd(r['!protect']));
    }
    function yd(e, r, t, a) {
        var n = Jr();
        var i = t.SheetNames[e],
        ...
        s['!comments'] = [];
        Zr(n, 'BrtBeginSheet');
        if (t.vbaraw) Zr(n, 'BrtWsProp', Hh(f));
        Zr(n, 'BrtWsDim', Mh(o));
        Ad(n, s, t.Workbook);
        _d(n, s);
        Cd(n, s, e, r, t);
        ...
        wd(n, s);
        Td(n, s, a);
        if (s['!margins']) Zr(n, 'BrtMargins', vd(s['!margins']));
    ...
    function jd(e) {
        ...
        Gd(e.WBView, Wd);
        Gd(e.Sheets, Vd);
        Qu.date1904 = je(e.WBProps.date1904);
    }
    function Kd(e) {
    ...
    function Jd(e) {
        ...
        Qd(e.SheetNames, r, !!e.vbaraw);
        for (var t = 0; t < e.SheetNames.length; ++t) ah(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
    }
    var Zd = /<\w+:workbook/;
    function qd(e, r) {
        ...
        e.replace(_e, function f(l, o) {
            ...
            switch (De(c[0])) {
                case '<?xml':
                    break;
                case '<workbook':
                    if (l.match(Zd)) n = 'xmlns' + l.match(/<(\w+):/)[1];
                    t.xmlns = c[n];
                    break;
                case '</workbook>':
                    break;
    ...
    var ev = fr('workbook', null, { xmlns: cr.main[0], 'xmlns:r': cr.r });
    function rv(e) {
        var r = [Ie];
        r[r.length] = ev;
    ...
    function hv(e, r) {
        ...
        Zr(e, 'BrtBookView', uv(n));
        Zr(e, 'BrtEndBookViews');
    }
    function dv(e, r) {
        var t = Jr();
        Zr(t, 'BrtBeginBook');
        Zr(t, 'BrtFileVersion', cv());
        Zr(t, 'BrtWbProp', iv((e.Workbook && e.Workbook.WBProps) || null));
        hv(t, e, r);
        ov(t, e, r);
        Zr(t, 'BrtEndBook');
        return t.end();
    ...
    function vv(e, r, t) {
        if (r.slice(-4) === '.bin') return lv(e, t);
        return qd(e, t);
    }
    ...
    function bv(e, r, t, a, n, i, s, f) {
        if (r.slice(-4) === '.bin') return jo(e, a, t, n, i, s, f);
        return Ko(e, a, t, n, i, s, f);
    }
    function gv(e, r, t, a, n, i, s, f) {
        if (r.slice(-4) === '.bin') return Go(e, a, t, n, i, s, f);
        return zo(e, a, t, n, i, s, f);
    }
    function Ev(e, r, t, a) {
        if (r.slice(-4) === '.bin') return Gl(e, t, a);
        return xl(e, t, a);
    }
    function Sv(e, r, t) {
        return co(e, t);
    ...
    function wv(e, r, t) {
        if (r.slice(-4) === '.bin') return Lo(e, t);
        return yo(e, t);
    }
    function Cv(e, r, t) {
        if (r.slice(-4) === '.bin') return Co(e, r, t);
        return ko(e, r, t);
    }
    function Bv(e, r, t) {
        if (r.slice(-4) === '.bin') return To(e, r, t);
        return Bo(e, r, t);
    }
    function Tv(e, r, t) {
        return (r.slice(-4) === '.bin' ? dv : rv)(e, t);
    }
    function xv(e, r, t, a, n) {
        return (r.slice(-4) === '.bin' ? yd : Fh)(e, t, a, n);
    }
    function Iv(e, r, t, a, n) {
        return (r.slice(-4) === '.bin' ? Ud : Nd)(e, t, a, n);
    }
    function Av(e, r, t) {
        return (r.slice(-4) === '.bin' ? ro : Al)(e, t);
    }
    function _v(e, r, t) {
        return (r.slice(-4) === '.bin' ? xf : kf)(e, t);
    }
    function Rv(e, r, t) {
        return (r.slice(-4) === '.bin' ? Uo : Do)(e, t);
    }
    var yv = /([\w:]+)=((?:")([^"]*)(?:")|(?:')([^']*)(?:'))/g;
    var Fv = /([\w:]+)=((?:")(?:[^"]*)(?:")|(?:')(?:[^']*)(?:'))/;
    function Dv(e, r) {
    ...
    function Lv(e, r, t) {
        if (t.cellStyles) {
            if (r.Interior) {
                var a = r.Interior;
                if (a.Pattern) a.patternType = ml[a.Pattern] || a.Pattern;
            }
        }
        e[r.ID] = r;
    }
    function Uv(e, r, t, a, n, i, s, f, l, o) {
        var c = 'General',
            u = a.StyleID,
            h = {};
        o = o || {};
        ...
        if (o.cellFormula !== false) {
            if (a.Formula) {
                ...
                a.f = $o(p, n);
                delete a.Formula;
                if (a.ArrayRange == 'RC') a.F = $o('RC:RC', n);
                else if (a.ArrayRange) {
                    a.F = $o(a.ArrayRange, n);
                    l.push([gt(a.F), a.F]);
                }
            } else {
    ...
    function Wv(e) {
        ...
        if (typeof Uint8Array !== 'undefined' && e instanceof Uint8Array) return Ke(I(_(e)));
        ...
        while ((s = Vv.exec(a)))
            switch (s[3]) {
                case 'Data':
                    ...
                    if (s[1] === '/') Uv(a.slice(S, s.index), x, E, f[f.length - 1][0] == 'Comment' ? M : b, { c: k, r: w }, B, L[k], g, W, t);
                    else {
                        x = '';
                        E = Dv(s[0]);
                ...
                case 'Column':
                    ...
                    if (!H && U.wpx > 10) {
                        H = true;
                        il = tl;
                        for (var J = 0; J < L.length; ++J) if (L[J]) ul(L[J]);
                    }
                    if (H) ul(U);
                ...
                case 'NamedRange':
                    ...
                    var ee = {
                        Name: q.Name,
                        Ref: $o(q.RefersTo.slice(1), { r: 0, c: 0 })
                    };
                ...
                case 'AppName':
                    if (s[0].slice(-2) === '/>') break;
                    else if (s[1] === '/') dn(_, s[3], a.slice(y, s.index));
                ...
                case 'AutoFilter':
                    if (s[1] === '/') {
                        ...
                        var re = Dv(s[0]);
                        h['!autofilter'] = { ref: $o(re.Range).replace(/\$/g, '') };
                        f.push([s[3], true]);
                    }
                    break;
                case 'Name':
                ...
                case 'WorksheetOptions':
                    ...
                    break;
                default:
                    if (f.length == 0 && s[3] == 'document') return Vp(a, t);
                    if (f.length == 0 && s[3] == 'UOF') return Vp(a, t);
                    var te = true;
                    ...
                    if (f[f.length - 1][0] === 'CustomDocumentProperties') {
                        if (s[0].slice(-2) === '/>') break;
                        else if (s[1] === '/') Nv(R, s[3], F, a.slice(y, s.index));
                        else {
                            F = s;
    ...
    function zv(e, r) {
        var t = [];
        if (e.Props) t.push(vn(e.Props, r));
        if (e.Custprops) t.push(pn(e.Props, e.Custprops, r));
        return t.join('');
    }
    function jv() {
        return '';
    ...
    function qv(e, r, t, a, n, i, s) {
        if (!e || (e.v == undefined && e.f == undefined)) return '';
        var f = {};
        if (e.f) f['ss:Formula'] = '=' + Ue(Qo(e.f, s));
        ...
        var d = rh(a.cellXfs, e, a);
        f['ss:StyleID'] = 's' + (21 + d);
        f['ss:Index'] = s.c + 1;
        var v = e.v != null ? h : '';
        var p = '<Data ss:Type="' + u + '">' + v + '</Data>';
        if ((e.c || []).length > 0) p += Zv(e.c);
        return fr('Cell', p, f);
    }
    function ep(e, r) {
    ...
    function ap(e, r) {
        ...
        t.push('');
        t.push('');
        for (var a = 0; a < e.SheetNames.length; ++a) t.push(fr('Worksheet', tp(a, r, e), { 'ss:Name': Ue(e.SheetNames[a]) }));
        t[2] = Kv(e, r);
        t[3] = Yv(e, r);
        return (
            Ie +
            ...
            if (q && q.f) {
                ...
                switch (te) {
                    ...
                    case 'Index':
                        break;
                    case 'Lbl':
                        $ = { Name: re.Name, Ref: _u(re.rgce, s, null, W, y) };
                        ...
                        W[W.length - 1].push(re);
                        if (re.Name == '_xlnm._FilterDatabase' && re.itab > 0) if (re.rgce && re.rgce[0] && re.rgce[0][0] && re.rgce[0][0][0] == 'PtgArea3d') j[re.itab - 1] = { ref: bt(re.rgce[0][0][1][2]) };
                        break;
                    case 'ExternCount':
                        y.ExternCount = re;
                        break;
                    ...
                    case 'BIFF2INT':
                        {
                            if (n['!type'] == 'chart') if (r.dense ? (n[re.r] || [])[re.c] : n[pt({ c: re.c, r: re.r })]) ++re.c;
                            k = { ixfe: re.ixfe, XF: B[re.ixfe] || {}, v: re.val, t: 'n' };
                            if (G > 0) k.z = z[(k.ixfe >> 8) & 31];
                            sp(k, r, t.opts.Date1904);
                            R({ c: re.c, r: re.r }, k, r);
                        }
                        break;
                    case 'BoolErr':
                    ...
                    case 'Formula':
                        {
                            ...
                            k = fp(re.val, re.cell.ixfe, re.tt);
                            k.XF = B[k.ixfe];
                            if (r.cellFormula) {
                                var fe = re.formula;
                                if (fe && fe[0] && fe[0][0] && fe[0][0][0] == 'PtgExp') {
                                    var le = fe[0][0][1][0],
                                        oe = fe[0][0][1][1];
                                    var ce = pt({ r: le, c: oe });
                                    if (E[ce]) k.f = '' + _u(re.formula, s, re.cell, W, y);
                                    else k.F = ((r.dense ? (n[le] || [])[oe] : n[ce]) || {}).F;
                                } else k.f = '' + _u(re.formula, s, re.cell, W, y);
                            }
                            if (G > 0) k.z = z[(k.ixfe >> 8) & 31];
                            sp(k, r, t.opts.Date1904);
                            R(re.cell, k, r);
                    ...
                    case 'String':
                        {
                            if (f) {
                                f.val = re;
                                k = fp(re, f.cell.ixfe, 's');
                                k.XF = B[k.ixfe];
                                if (r.cellFormula) {
                                    k.f = '' + _u(f.formula, s, f.cell, W, y);
                                }
                                if (G > 0) k.z = z[(k.ixfe >> 8) & 31];
                                sp(k, r, t.opts.Date1904);
                                R(f.cell, k, r);
                    ...
                    case 'Note':
                        {
                            ...
                            v = r.dense ? (n[re[0].r] || [])[re[0].c] : n[pt(re[0])];
                            var me = P[re[2]];
                            if (!v) {
                                if (r.dense) {
    ...
    function up(e, r) {
        ...
        if (e.Props) {
            s = K(e.Props);
            for (i = 0; i < s.length; ++i) (ka.hasOwnProperty(s[i]) ? t : wa.hasOwnProperty(s[i]) ? a : n).push([s[i], e.Props[s[i]]]);
        }
        if (e.Custprops) {
            s = K(e.Custprops);
            for (i = 0; i < s.length; ++i) if (!(e.Props || {}).hasOwnProperty(s[i])) (ka.hasOwnProperty(s[i]) ? t : wa.hasOwnProperty(s[i]) ? a : n).push([s[i], e.Custprops[s[i]]]);
        }
        var f = [];
        ...
        if (a.length) V.utils.cfb_add(r, '/SummaryInformation', Ln(a, op.SI, wa, Ea));
        if (t.length || f.length) V.utils.cfb_add(r, '/DocumentSummaryInformation', Ln(t, op.DSI, ka, ga, f.length ? f : null, op.UDI));
    }
    function hp(e, r) {
        if (!r) r = {};
        nm(r);
        ...
        if (r.bookProps && !r.bookSheets) n = {};
            ...
            if (r.bookVBA && e.FullPaths && V.find(e, '/_VBA_PROJECT_CUR/VBA/dir')) n.vbaraw = Wo(e);
        }
        var l = {};
        if (e.FullPaths) cp(e, l, r);
    ...
    function dp(e, r) {
        ...
        V.utils.cfb_add(a, n, Op(e, t));
        if (t.biff == 8 && (e.Props || e.Custprops)) up(e, a);
    ...
    var vp = {
        0: { n: 'BrtRowHdr', f: Dh },
        1: { n: 'BrtCellBlank', f: Wh },
        2: { n: 'BrtCellRk', f: Qh },
        3: { n: 'BrtCellError', f: zh },
        4: { n: 'BrtCellBool', f: Xh },
        5: { n: 'BrtCellReal', f: $h },
        6: { n: 'BrtCellSt', f: Zh },
        7: { n: 'BrtCellIsst', f: jh },
        8: { n: 'BrtFmlaString', f: ad },
        9: { n: 'BrtFmlaNum', f: td },
        10: { n: 'BrtFmlaBool', f: ed },
        11: { n: 'BrtFmlaError', f: rd },
        16: { n: 'BrtFRTArchID$', f: sv },
        ...
        147: { n: 'BrtWsProp', f: Uh },
        148: { n: 'BrtWsDim', f: Nh, p: 16 },
        151: { n: 'BrtPane' },
        152: { n: 'BrtSel' },
        153: { n: 'BrtWbProp', f: nv },
        154: { n: 'BrtWbFactoid' },
        155: { n: 'BrtFileRecover' },
        156: { n: 'BrtBundleSh', f: tv },
        157: { n: 'BrtCalcProp' },
        158: { n: 'BrtBookView' },
        ...
        632: { n: 'BrtCommentAuthor', f: No },
        633: { n: 'BrtBeginCommentList' },
        634: { n: 'BrtEndCommentList' },
        635: { n: 'BrtBeginComment', f: Oo },
        636: { n: 'BrtEndComment' },
    ...
    var mp = {
        ...
        81: { n: 'DConRef' },
        82: { n: 'DConName' },
        85: { n: 'DefColWidth', f: Gn },
        89: { n: 'XCT' },
        90: { n: 'CRN' },
        91: { n: 'FileSharing' },
        92: { n: 'WriteAccess', f: Ri },
        93: { n: 'Obj', f: As },
        94: { n: 'Uncalced' },
        ...
        154: { n: 'FnGroupName' },
        155: { n: 'FilterMode' },
        156: { n: 'BuiltInFnGroupCount', f: Gn },
        ...
        2211: { n: 'ForceFullCalculation', f: Li },
        ...
        8: { n: 'BIFF2ROW' },
        11: { n: 'Index' },
        22: { n: 'ExternCount', f: Gn },
        30: { n: 'BIFF2FORMAT', f: Zi },
        31: { n: 'BIFF2FMTCNT' },
        32: { n: 'BIFF2COLINFO' },
        33: { n: 'Array', f: ws },
        ...
        if (r.v != null)
            switch (r.t) {
                ...
                case 'n':
                    ...
                    if (n == (n | 0) && n >= 0 && n < 65536) gp(e, 2, qs(t, a, n));
                    else gp(e, 3, Js(t, a, n));
                    return;
                case 'b':
                case 'e':
                    gp(e, 5, Sp(t, a, r.v, r.t));
                    return;
                case 's':
                case 'str':
                    gp(e, 4, kp(t, a, r.v));
    ...
    function Bp(e, r) {
        ...
        gp(a, 9, Ai(e, 16, t));
        Cp(a, e.Sheets[e.SheetNames[n]], n, t, e);
        gp(a, 10);
        return a.end();
    }
    function Tp(e, r, t) {
    ...
    function xp(e, r, t) {
        ...
        [
            ...
            for (var n = a[0]; n <= a[1]; ++n) if (r[n] != null) gp(e, 'Format', Ji(n, r[n], t));
        });
    }
    function Ip(e, r) {
        var t = Yr(19);
    ...
    function Ap(e, r) {
        for (var t = 0; t < 16; ++t) gp(e, 'XF', ss({ numFmtId: 0, style: true }, 0, r));
    ...
    function _p(e, r) {
        for (var t = 0; t < r['!links'].length; ++t) {
            var a = r['!links'][t];
            gp(e, 'HLink', Ds(a));
            if (a[1].Tooltip) gp(e, 'HLinkTooltip', Ps(a));
        }
        delete r['!links'];
    }
    function Rp(e, r, t, a, n) {
        var i = 16 + rh(n.cellXfs, r, n);
        if (r.v != null)
            switch (r.t) {
                case 'd':
                case 'n':
                    var s = r.t == 'd' ? re(se(r.v)) : r.v;
                    gp(e, 'Number', hs(t, a, s, i, n));
                    return;
                case 'b':
                case 'e':
                    gp(e, 517, cs(t, a, r.v, i, n, r.t));
                    return;
                case 's':
                case 'str':
                    gp(e, 'Label', Yi(t, a, r.v, i, n));
                    return;
            }
        gp(e, 'Blank', ui(t, a, i));
    }
    function yp(e, r, t) {
        ...
        gp(a, 2057, Ai(t, 16, r));
        gp(a, 'CalcMode', zn(1));
        gp(a, 'CalcCount', zn(100));
        gp(a, 'CalcRefMode', Xn(true));
        gp(a, 'CalcIter', Xn(false));
        gp(a, 'CalcDelta', Yt(0.001));
        gp(a, 'CalcSaveRecalc', Xn(true));
        gp(a, 'PrintRowCol', Xn(false));
        gp(a, 'PrintGrid', Xn(false));
        gp(a, 'GridSet', zn(1));
        gp(a, 'Guts', ls([0, 0]));
        gp(a, 'HCenter', Xn(false));
        gp(a, 'VCenter', Xn(false));
        gp(a, 512, es(d, r));
        if (o) i['!links'] = [];
        ...
        if (o && s.Views) gp(a, 'Window2', Gi(s.Views[0]));
        if (o && (i['!merges'] || []).length) gp(a, 'MergeCells', Is(i['!merges']));
        if (o) _p(a, i);
        gp(a, 'CodeName', ei(g, r));
        if (o) Ip(a, i);
        gp(a, 'EOF');
        return a.end();
    }
    function Fp(e, r, t) {
        ...
        gp(a, 'InterfaceHdr', f ? zn(1200) : null);
        gp(a, 'Mms', Hn(2));
        if (l) gp(a, 'ToolbarHdr');
        if (l) gp(a, 'ToolbarEnd');
        gp(a, 'InterfaceEnd');
        gp(a, 'WriteAccess', yi('SheetJS', t));
        gp(a, 'CodePage', zn(f ? 1200 : 1252));
        if (f) gp(a, 'DSF', zn(0));
        if (f) gp(a, 'Excel9File');
        gp(a, 'RRTabId', Gs(e.SheetNames.length));
        if (f && e.vbaraw) {
            gp(a, 'ObProj');
            var o = s.CodeName || 'ThisWorkbook';
            gp(a, 'CodeName', ei(o, t));
        }
        gp(a, 'BuiltInFnGroupCount', zn(17));
        gp(a, 'WinProtect', Xn(false));
        gp(a, 'Protect', Xn(false));
        gp(a, 'Password', zn(0));
        if (f) gp(a, 'Prot4Rev', Xn(false));
        if (f) gp(a, 'Prot4RevPass', zn(0));
        gp(a, 'Window1', Vi(t));
        gp(a, 'Backup', Xn(false));
        gp(a, 'HideObj', zn(0));
        gp(a, 'Date1904', Xn(Kd(e) == 'true'));
        gp(a, 'CalcPrecision', Xn(true));
        if (f) gp(a, 'RefreshAll', Xn(false));
        gp(a, 'BookBool', zn(0));
        Tp(a, e, t);
        xp(a, e.SSF, t);
        Ap(a, t);
        if (f) gp(a, 'UsesELFs', Xn(false));
        var c = a.end();
        var u = Jr();
        if (f) gp(u, 'Country', Ms());
        gp(u, 'EOF');
        var h = u.end();
        var d = Jr();
        var v = 0,
        ...
        for (p = 0; p < e.SheetNames.length; ++p) {
            var b = i[p] || {};
            gp(d, 'BoundSheet8', Oi({ pos: m, hs: b.Hidden || 0, dt: 0, name: e.SheetNames[p] }, t));
            m += r[p].length;
        }
        var g = d.end();
    ...
    function Dp(e, r) {
        ...
        t.Strings.Count = 0;
        t.Strings.Unique = 0;
        rh(t.cellXfs, {}, { revssf: { General: 0 } });
        for (var n = 0; n < e.SheetNames.length; ++n) a[a.length] = yp(n, t, e);
        a.unshift(Fp(e, a, t));
        return vr([a]);
    }
    function Op(e, r) {
    ...
    var Pp = (function() {
        function e(e, r) {
            ...
            for (s = 0; s < l.length; ++s) {
                ...
                for (f = 0; f < g.length; ++f) {
                    ...
                    var w = Fe(E.slice(0, E.indexOf('>')));
                    h = w.colspan ? +w.colspan : 1;
                    if ((u = +w.rowspan) > 1 || h > 1)
                        v.push({
                            s: { r: o, c: c },
                            e: { r: o + (u || 1) - 1, c: c + h - 1 }
                        });
        ...
        function t(e, r, t, a) {
            ...
            for (var s = r.s.c; s <= r.e.c; ++s) {
                ...
                if (f > 1) h.rowspan = f;
                if (l > 1) h.colspan = l;
                var d = (u && u.v != null && (u.h || Ve(u.w || (St(u), u.w) || ''))) || '';
                h.t = (u && u.t) || 'z';
    ...
    function Np(e, r) {
        ...
        for (; c < n.length && u < i; ++c) {
            ...
            for (h = d = 0; h < g.length; ++h) {
                ...
                if ((v = +E.getAttribute('rowspan')) > 0 || p > 1)
                    f.push({
                        s: { r: u, c: d },
                        e: { r: u + (v || 1) - 1, c: d + p - 1 }
                    });
        ...
        s.e.r = u - 1;
        a['!ref'] = bt(s);
        if (u >= i) a['!fullref'] = bt(((s.e.r = n.length - c + u - 1), s));
        return a;
    }
    function Mp(e, r) {
        return kt(Np(e, r), r);
        ...
        return function t(a, n) {
            ...
            while ((E = Vv.exec(s)))
                switch ((E[3] = E[3].replace(/_.*$/, ''))) {
                    ...
                    case '工作表':
                        if (E[1] === '/') {
                            if (A.e.c >= A.s.c && A.e.r >= A.s.r) g['!ref'] = bt(A);
                    ...
                    case '数据':
                        if (E[0].charAt(E[0].length - 2) === '/') {
                            ...
                            S = { t: 'z', v: null };
                            if (k.formula && i.cellFormula != false) S.f = zu(Ne(k.formula));
                                ...
                                if (!(i.sheetRows && i.sheetRows <= x)) {
                                    for (var Q = 0; Q < N; ++Q) {
                                        ...
                                        if (i.dense) {
                                            ...
                                            g[pt({ r: x + Q, c: I })] = S;
                                            while (--M > 0) g[pt({ r: x + Q, c: I + M })] = le(S);
                                        }
                                        if (A.e.c <= I) A.e.c = I;
                                    }
                                }
                    ...
                    case 'database-range':
                        if (E[1] === '/') break;
                        try {
                            W = Ku(Fe(E[0])['target-range-address']);
    ...
    function zp(e, r) {
        if (r.bookType == 'fods') return Gp(e, r);
        var t = Te();
        var a = '';
        var n = [];
        var i = [];
    ...
    var $p = Kp(Pp);
    var Yp = Kp({ from_sheet: Mm });
    var Qp = Kp(typeof nf !== 'undefined' ? nf : {});
    var Jp = Kp(typeof sf !== 'undefined' ? sf : {});
    var Zp = Kp(typeof lf !== 'undefined' ? lf : {});
    var qp = Kp(typeof Qf !== 'undefined' ? Qf : {});
    var em = Kp({ from_sheet: Lm });
    var rm = Kp(typeof af !== 'undefined' ? af : {});
    var tm = Kp(typeof ff !== 'undefined' ? ff : {});
    function am(e) {
        return function r(t) {
            for (var a = 0; a != e.length; ++a) {
                var n = e[a];
    ...
    function fm(e, r) {
        ...
        try {
            e = r.map(function a(r) {
                ...
                return [r.name, e['!id'][r.id].Target, sm(e['!id'][r.id].Type)];
            });
        } catch (t) {
            return null;
        }
    ...
    function lm(e, r, t, a, n, i, s, f, l, o, c, u) {
        try {
            i[a] = Ma(Se(e, t, true), r);
            var h = Ee(e, r);
            var d;
            switch (f) {
                case 'sheet':
                ...
                case 'chart':
                    ...
                    if (!d || !d['!chart']) break;
                    var v = xe(d['!chart'].Target, r);
                    var p = Na(v);
                    var m = xo(Se(e, v, true), Ma(Se(e, p, true), v));
                    var b = xe(m, v);
                    var g = Na(b);
                    d = Dd(Se(e, b, true), b, l, Ma(Se(e, g, true), b), o, d);
                    break;
                case 'macro':
                    d = bv(h, r, n, l, i[a], o, c, u);
                    break;
                case 'dialog':
                    d = gv(h, r, n, l, i[a], o, c, u);
                    break;
            }
            s[a] = d;
        } catch (E) {
    ...
    function cm(e, r) {
        ...
        r = r || {};
        nm(r);
        if (be(e, 'META-INF/manifest.xml')) return Wp(e, r);
        if (be(e, 'objectdata.xml')) return Wp(e, r);
        if (be(e, 'Index/Document.iwa')) throw new Error('Unsupported NUMBERS file');
        var t = ke(e);
        var a = ya(Se(e, '[Content_Types].xml'));
        var n = false;
        var i, s;
        ...
        if (!r.bookSheets && !r.bookProps) {
            ...
            if (a.sst)
                try {
                    Yu = kv(Ee(e, om(a.sst)), a.sst, r);
                } catch (o) {
                    if (r.WTF) throw o;
                }
            if (r.cellStyles && a.themes.length) f = Sv(Se(e, a.themes[0].replace(/^\//, ''), true) || '', a.themes[0], r);
            if (a.style) l = Ev(Ee(e, om(a.style)), a.style, f, r);
        }
        a.links.map(function(t) {
            return Bv(Ee(e, om(t)), t, r);
        });
        var c = vv(Ee(e, om(a.workbooks[0])), a.workbooks[0], r);
        var u = {},
            h = '';
        if (a.coreprops.length) {
            h = Ee(e, om(a.coreprops[0]), true);
            if (h) u = Qa(h);
            if (a.extprops.length !== 0) {
                h = Ee(e, om(a.extprops[0]), true);
                if (h) an(h, u, r);
            }
        }
        var d = {};
        ...
        i = {};
        var p = {};
        if (r.bookDeps && a.calcchain) p = Cv(Ee(e, om(a.calcchain)), a.calcchain, r);
        var m = 0;
        var b = {};
        var g, E;
        {
        ...
        var T = Ma(Se(e, B, true), B);
        if (T) T = fm(T, c.Sheets);
        ...
        for (m = 0; m != u.Worksheets; ++m) {
            ...
            lm(e, g, E, u.SheetNames[m], m, b, i, I, r, c, f, l);
        }
        ...
        if (r.bookVBA) {
            if (a.vba.length > 0) v.vbaraw = Ee(e, om(a.vba[0]), true);
            else if (a.defaults && a.defaults.bin === Ho) v.vbaraw = Ee(e, 'xl/vbaProject.bin', true);
        }
        return v;
    }
    function um(e, r) {
    ...
    function hm(e, r) {
        Io = 1024;
        if (r.bookType == 'ods') return zp(e, r);
        if (e && !e.SSF) {
            e.SSF = D.get_table();
        }
        if (e && e.SSF) {
        ...
        for (f = 1; f <= e.SheetNames.length; ++f) {
            ...
            if (u) {
                ...
                if (u['!legacy']) {
                    if (v) we(i, 'xl/drawings/vmlDrawing' + f + '.vml', Ao(f, u['!comments']));
                }
                delete u['!comments'];
                delete u['!legacy'];
            }
            if (c['!id'].rId1) we(i, Na(s), Ua(c));
        }
        if (r.Strings != null && r.Strings.length > 0) {
            s = 'xl/sharedStrings.' + t;
            we(i, s, _v(r.Strings, s, r));
            n.strs.push(s);
        ...
        we(i, '[Content_Types].xml', Oa(n, r));
        we(i, '_rels/.rels', Ua(r.rels));
        we(i, 'xl/_rels/workbook.' + t + '.rels', Ua(r.wbrels));
        delete r.revssf;
        delete r.ssf;
        return i;
    }
    ...
    function vm(e, r) {
        if (V.find(e, 'EncryptedPackage')) return um(e, r);
        return hp(e, r);
    }
    function pm(e, r) {
        var t,
    ...
    function Em(e) {
        return !e.match(/[^\x00-\x7F]/) ? e : $e(e);
    }
    function Sm(e, r, t, a) {
        if (a) {
            t.type = 'string';
            return lf.to_workbook(e, t);
        }
        return lf.to_workbook(r, t);
    }
    function km(e, r) {
        o();
        if (typeof ArrayBuffer !== 'undefined' && e instanceof ArrayBuffer) return km(new Uint8Array(e), r);
        var t = e,
            a = [0, 0, 0, 0],
            n = false;
        var i = r || {};
        Qu = {};
        if (i.dateNF) Qu.dateNF = i.dateNF;
        ...
        switch ((a = dm(t, i))[0]) {
            case 208:
                return vm(V.read(t, i), i);
            case 9:
                return hp(t, i);
            case 60:
                return Gv(t, i);
            case 73:
                if (a[1] === 68) return of(t, i);
                break;
            case 84:
                if (a[1] === 65 && a[2] === 66 && a[3] === 76) return sf.to_workbook(t, i);
                break;
            case 80:
                return a[1] === 75 && a[2] < 9 && a[3] < 9 ? pm(t, i) : Sm(e, t, i, n);
            case 239:
                return a[3] === 60 ? Gv(t, i) : Sm(e, t, i, n);
            case 255:
                if (a[1] === 254) {
                    return gm(t, i);
                }
            ...
            case 123:
                if (a[1] === 92 && a[2] === 114 && a[3] === 116) return Qf.to_workbook(t, i);
                break;
            case 10:
            case 13:
            case 32:
    ...
    function Bm(e, r) {
        ...
        var i = a.FullPaths
            ...
            : a.generate(n);
        if (t.password && typeof encrypt_agile !== 'undefined') return Cm(encrypt_agile(i, t.password), t);
    ...
    function Fm(e, r, t, a) {
        ...
        return X.writeFile(e, _m(r, n), i);
    }
    function Dm(e, r, t, a, n, i, s, f) {
        var l = st(t);
        var o = f.defval,
    ...
    function Mm(e, r) {
        ...
        for (var v = n.s.c; v <= n.e.c; ++v) if (!(h[v] || {}).hidden) u[v] = ct(v);
        for (var p = n.s.r; p <= n.e.r; ++p) {
            if ((d[p] || {}).hidden) continue;
            c = Nm(e, n, p, u, s, l, i, a);
            if (c == null) {
                continue;
            }
    ...
    function Hm(e, r, t) {
        ...
        var v = st(s);
        if (n) for (d = 0; d < h.length; ++d) i[ct(d + f) + v] = { t: 's', v: h[d] };
        i['!ref'] = bt(c);
        return i;
    }
    function Wm(e, r) {
    ...
    var Vm = {
        ...
        sheet_to_formulae: Um,
        sheet_to_row_object_array: Om
    };
    (function(e) {
        e.consts = e.consts || {};
        function r(r) {
    ...
    if (E && typeof require != 'undefined')
        (function() {
            ...
            var t = function(e, t) {
                ...
                for (var p = i.s.c; p <= i.e.c; ++p) if (!(d[p] || {}).hidden) h[p] = ct(p);
                var m = i.s.r;
                var b = false;
                a._read = function() {
                    if (!b) {
    ...
    if (typeof hp !== 'undefined') e.parse_xlscfb = hp;
    e.parse_zip = cm;
    e.read = km;
    e.readFile = wm;
    e.readFileSync = wm;
