...
function make_xlsx_lib(e) {
    ...
    var R = function Sl(e) {
        ...
        e.parse_date_code = m;
        var g = new Date(1899, 11, 31, 0, 0, 0);
        var b = g.getTime();
        ...
        function k(e, r) {
            ...
            return (t - (b + (e.getTimezoneOffset() - g.getTimezoneOffset()) * 6e4)) / (24 * 60 * 60 * 1e3);
        }
        function y(e) {
        ...
        function S(e, r) {
            switch (typeof e) {
                ...
                case 'boolean':
                    return e ? 'TRUE' : 'FALSE';
                case 'number':
                    return (e | 0) === e ? y(e) : x(e);
                case 'undefined':
                    return '';
                case 'object':
                    if (e == null) return '';
                    if (e instanceof Date) return I(14, k(e, r && r.date1904), r);
            }
        ...
        var F = (function z() {
            ...
            function s(r, a, n) {
                var i = a.replace(e, ''),
                    s = a.length - i.length;
                return F(r, i, n * Math.pow(10, 2 * s)) + t('%', s);
            }
            function l(e, r, t) {
                var a = r.length - 1;
                while (r.charCodeAt(a - 1) === 44) --a;
                return F(e, r.substr(0, a), t / Math.pow(10, 3 * (r.length - a)));
            }
            function o(e, r) {
                var t;
            ...
            function x(e, u, S) {
                if (e.charCodeAt(0) === 40 && !u.match(p)) {
                    var C = u
                        ...
                        .replace(/ \)/, '')
                        .replace(/\)/, '');
                    if (S >= 0) return x('n', C, S);
                    return '(' + x('n', C, -S) + ')';
                }
                if (u.charCodeAt(u.length - 1) === 44) return l(e, u, S);
                if (u.indexOf('%') !== -1) return s(e, u, S);
                if (u.indexOf('E') !== -1) return o(u, S);
                if (u.charCodeAt(0) === 36) return '$' + x(e, u.substr(u.charAt(1) == ' ' ? 2 : 1), S);
                var _;
                var A,
                    T,
                    O,
                ...
                if (u.match(/^[#?]+$/)) {
                    _ = f(S, 0);
                    if (_ === '0') _ = '';
                    return _.length > u.length ? _ : g(u.substr(0, u.length - _.length)) + _;
                }
                ...
                if ((A = u.match(d))) {
                    _ = b(S, A[1].length)
                        ...
                        .replace(/\.(\d*)$/, function(e, r) {
                            return '.' + r + t('0', g(A[1]).length - r.length);
                        });
                ...
                if ((A = u.match(/^#{1,3},##0(\.?)$/))) return M + E(f(D, 0));
                if ((A = u.match(/^#,##0\.([#0]*0)$/))) {
                    return S < 0 ? '-' + x(e, u, -S) : E('' + (Math.floor(S) + k(S, A[1].length))) + '.' + a(w(S, A[1].length), A[1].length);
                }
                if ((A = u.match(/^#,#*,#0/))) return x(e, u.replace(/^#,#*,/, ''), S);
                if ((A = u.match(/^([0#]+)(\\?-([0#]+))+$/))) {
                    _ = r(x(e, u.replace(/[\\-]/g, ''), S));
                    T = 0;
                    return r(
                        r(u.replace(/\\/g, '')).replace(/[0#]/g, function(e) {
                            return T < _.length ? _.charAt(T++) : e === '0' ? '0' : '';
                        })
                    );
                }
                if (u.match(m)) {
                ...
                if ((A = u.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
                    ...
                    O = v(D, Math.pow(10, T) - 1, false);
                    _ = '' + M;
                    P = F('n', A[1], O[1]);
                    if (P.charAt(P.length - 1) == ' ') P = P.substr(0, P.length - 1) + '0';
                    _ += P + A[2] + '/' + A[3];
                    P = i(O[2], T);
                    if (P.length < A[4].length) P = g(A[4].substr(A[4].length - P.length)) + P;
                    _ += P;
                    return _;
                }
                if ((A = u.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
                    T = Math.min(Math.max(A[1].length, A[4].length), 7);
                    O = v(D, Math.pow(10, T) - 1, true);
                    return M + (O[0] || (O[1] ? '' : '0')) + ' ' + (O[1] ? n(O[1], T) + A[2] + '/' + A[3] + i(O[2], T) : t(' ', 2 * T + 1 + A[2].length + A[3].length));
                }
                if ((A = u.match(/^[#0?]+$/))) {
                    _ = f(S, 0);
                    if (u.length <= _.length) return _;
                    return g(u.substr(0, u.length - _.length)) + _;
                }
                if ((A = u.match(/^([#0?]+)\.([#0]+)$/))) {
                    _ = '' + S.toFixed(Math.min(A[2].length, 10)).replace(/([^0])0+$/, '$1');
                    T = _.indexOf('.');
                    var R = u.indexOf('.') - T,
                        N = u.length - _.length - R;
                    return g(u.substr(0, R) + _ + u.substr(u.length - N));
                }
            ...
            function A(e, s, l) {
                ...
                if (s.match(/^[#?]+$/)) {
                    f = '' + l;
                    if (l === 0) f = '';
                    return f.length > s.length ? f : g(s.substr(0, s.length - f.length)) + f;
                }
                if ((h = s.match(c))) return u(h, k, y);
                if (s.match(/^#+0+$/)) return y + a(k, s.length - s.indexOf('0'));
                if ((h = s.match(d))) {
                    f = ('' + l).replace(/^([^\.]+)$/, '$1.' + g(h[1])).replace(/\.$/, '.' + g(h[1]));
                ...
                if ((h = s.match(/^#{1,3},##0(\.?)$/))) return y + E('' + k);
                if ((h = s.match(/^#,##0\.([#0]*0)$/))) {
                    return l < 0 ? '-' + A(e, s, -l) : E('' + l) + '.' + t('0', h[1].length);
                }
                ...
                if ((h = s.match(/^([0#]+)(\\?-([0#]+))+$/))) {
                    ...
                    return r(
                        r(s.replace(/\\/g, '')).replace(/[0#]/g, function(e) {
                            return b < f.length ? f.charAt(b++) : e === '0' ? '0' : '';
                        })
                    );
                }
                if (s.match(m)) {
                ...
                if ((h = s.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
                    ...
                    w = v(k, Math.pow(10, b) - 1, false);
                    f = '' + y;
                    x = F('n', h[1], w[1]);
                    if (x.charAt(x.length - 1) == ' ') x = x.substr(0, x.length - 1) + '0';
                    f += x + h[2] + '/' + h[3];
                    x = i(w[2], b);
                    if (x.length < h[4].length) x = g(h[4].substr(h[4].length - x.length)) + x;
                    f += x;
                    return f;
                }
                if ((h = s.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
                    b = Math.min(Math.max(h[1].length, h[4].length), 7);
                    w = v(k, Math.pow(10, b) - 1, true);
                    return y + (w[0] || (w[1] ? '' : '0')) + ' ' + (w[1] ? n(w[1], b) + h[2] + '/' + h[3] + i(w[2], b) : t(' ', 2 * b + 1 + h[2].length + h[3].length));
                }
                if ((h = s.match(/^[#0?]+$/))) {
                    f = '' + l;
                    if (s.length <= f.length) return f;
                    return g(s.substr(0, s.length - f.length)) + f;
                }
                if ((h = s.match(/^([#0]+)\.([#0]+)$/))) {
                    f = '' + l.toFixed(Math.min(h[2].length, 10)).replace(/([^0])0+$/, '$1');
                    b = f.indexOf('.');
                    var T = s.indexOf('.') - b,
                        O = s.length - f.length - T;
                    return g(s.substr(0, T) + f + s.substr(s.length - O));
                }
                ...
                switch (s) {
                    ...
                    case '#,###':
                        ...
                        return D !== '0' ? y + D : '';
                    default:
                        if (s.match(/\.[0#?]*$/)) return A(e, s.slice(0, s.lastIndexOf('.')), l) + g(s.slice(s.lastIndexOf('.')));
                }
        ...
        function D(e, r, t, a) {
            ...
            for (s = 0; s < n.length; ++s) {
                switch (n[s].t) {
                    ...
                    case 'b':
                    case 'Z':
                        n[s].v = _(n[s].t.charCodeAt(0), n[s].v, f, w);
                        n[s].t = 't';
                        break;
                    case 'n':
                    case '(':
                    case '?':
                        ...
                        while (
                            ...
                            ((l = n[x].t) === '?' ||
                                l === 'D' ||
                                ((l === ' ' || l === 't') && n[x + 1] != null && (n[x + 1].t === '?' || (n[x + 1].t === 't' && n[x + 1].v === '/'))) ||
                                (n[s].t === '(' && (l === ' ' || l === 'n' || l === ')')) ||
                                (l === 't' && (n[x].v === '/' || (n[x].v === ' ' && n[x + 1] != null && n[x + 1].t == '?'))))
                        ) {
                            n[s].v += n[x].v;
                            n[x] = { v: '', t: ';' };
                            ++x;
            ...
            if (y.length > 0) {
                ...
                var M = n.length;
                if (D === n.length && A.indexOf('E') === -1) {
                    for (s = n.length - 1; s >= 0; --s) {
                        if (n[s] == null || 'n?('.indexOf(n[s].t) === -1) continue;
                        if (x >= n[s].v.length - 1) {
                            x -= n[s].v.length;
                            n[s].v = A.substr(x + 1, n[s].v.length);
                        } else if (x < 0) n[s].v = '';
                        else {
                            n[s].v = A.substr(0, x + 1);
                            x = -1;
                        }
                        n[s].t = 't';
                        M = s;
                    }
                    if (x >= 0 && M < n.length) n[M].v = A.substr(0, x + 1) + n[M].v;
                } else if (D !== n.length && A.indexOf('E') === -1) {
                    x = A.indexOf('.') - 1;
                    for (s = D; s >= 0; --s) {
                        if (n[s] == null || 'n?('.indexOf(n[s].t) === -1) continue;
                        h = n[s].v.indexOf('.') > -1 && s === D ? n[s].v.indexOf('.') - 1 : n[s].v.length - 1;
                        C = n[s].v.substr(h + 1);
                        for (; h >= 0; --h) {
                            if (x >= 0 && (n[s].v.charAt(h) === '0' || n[s].v.charAt(h) === '#')) C = A.charAt(x--) + C;
                        }
                        n[s].v = C;
                        n[s].t = 't';
                        M = s;
                    ...
                    if (x >= 0 && M < n.length) n[M].v = A.substr(0, x + 1) + n[M].v;
                    x = A.indexOf('.') + 1;
                    for (s = D; s < n.length; ++s) {
                        if (n[s] == null || ('n?('.indexOf(n[s].t) === -1 && s !== D)) continue;
                        h = n[s].v.indexOf('.') > -1 && s === D ? n[s].v.indexOf('.') + 1 : 0;
                        C = n[s].v.substr(0, h);
                        for (; h < n[s].v.length; ++h) {
                            if (x < A.length) C += A.charAt(x++);
                        }
                        n[s].v = C;
                        n[s].t = 't';
                        M = s;
            ...
            for (s = 0; s < n.length; ++s)
                if (n[s] != null && 'n(?'.indexOf(n[s].t) > -1) {
                    ...
                    n[s].v = F(n[s].t, n[s].v, E);
                    n[s].t = 't';
                }
            var P = '';
            for (s = 0; s !== n.length; ++s) if (n[s] != null) P += n[s].v;
            return P;
        }
        e._eval = D;
        var M = /\[[=<>]/;
        ...
        function N(e, r) {
            ...
            if (t[0].match(M) != null || t[1].match(M) != null) {
                var s = t[0].match(P);
                var l = t[1].match(P);
                return R(r, s) ? [a, t[0]] : R(r, l) ? [a, t[1]] : [a, t[s != null && l != null ? 2 : 1]];
            }
            return [a, i];
        }
        function I(e, r, t) {
    ...
    var j = (function Cl() {
        ...
        function f(e, r) {
            if (e[0] == 80 && e[1] == 75) return Ee(e, r);
            ...
            d(F, A, E);
            E.shift();
            var T = { FileIndex: F, FullPaths: A };
            if (r && r.raw) T.raw = { header: b, sectors: S };
            return T;
        }
        function c(e) {
        ...
        function v(e, r, t, a, n) {
            ...
            if (e === I) {
                ...
                if (!s) return;
                for (var o = 0; o < l; ++o) {
                    if ((i = Br(s, o * 4)) === I) break;
                    n.push(i);
                }
                v(Br(s, a - 4), r - 1, t, a, n);
            }
        }
        ...
        function k(e, r, t, a, n, i, s, l) {
            ...
            for (; h < c.length; h += 128) {
                ...
                if (g.type === 5) {
                    ...
                    else if (o !== I && g.start !== I && r[o]) {
                        g.content = p(g, r[o].data, (r[l] || {}).data);
                    }
                }
                if (g.content) Xr(g.content, 0);
                i[d] = g;
                s.push(g);
            }
        }
        function y(e, r) {
            return new Date(((Lr(e, r + 4) / 1e7) * Math.pow(2, 32) + Lr(e, r) / 1e7 - 11644473600) * 1e3);
        }
        function x(e, r) {
            o();
        ...
        function T(e, n) {
            ...
            for (l = 0; l < h.length; ++l) {
                ...
                if (l === 0) {
                    ...
                    for (c = l + 1; c < h.length; ++c) if (t(e.FullPaths[c]) == p) break;
                    d.C = c >= h.length ? -1 : c;
                    for (c = l + 1; c < h.length; ++c) if (t(e.FullPaths[c]) == t(p)) break;
                    d.R = c >= h.length ? -1 : c;
                    d.type = 1;
                } else {
        ...
        function P(e, r) {
            ...
            var a = (function(e) {
                ...
                while ((f + c + h + 127) >> 7 > c) h = ++c <= 109 ? 0 : Math.ceil((c - 109) / 127);
        ...
        var ue = (function() {
            ...
            return function(r) {
                var t = Yr(50 + Math.floor(r.length * 1.1));
                var a = e(r, t);
                return t.slice(0, a);
            };
        })();
        function de(e, r, t) {
            ...
            f[0] = 0;
            for (i = 1; i <= a; ++i) f[i + 16] = l = (l + f[i - 1]) << 1;
            for (i = 0; i < o; ++i) {
                l = e[i];
                if (l != 0) c[i] = f[l + 16]++;
            }
            ...
            for (i = 0; i < o; ++i) {
                ...
                if (h != 0) {
                    l = ae(c[i], a) >> (a - h);
                    for (s = (1 << (a + 4 - h)) - 1; s >= 0; --s) r[l | (s << h)] = (h & 15) | (i << 4);
                }
            }
            return a;
        }
        ...
        if (!ee) {
            for (var me = 0; me < 512; ++me) pe[me] = 0;
            for (me = 0; me < 32; ++me) ve[me] = 0;
        }
        (function() {
            var e = [];
            var r = 0;
        ...
        function xe(e, r) {
            ...
            var d = 0;
            f[0] = 0;
            for (u = 1; u <= o; ++u) c[u] = d = (d + f[u - 1]) << 1;
            for (u = 0; u < h; ++u) if ((d = s[u]) != 0) l[u] = c[d]++;
            var p = 0;
            for (u = 0; u < h; ++u) {
                p = s[u];
                if (p != 0) {
    ...
    function X(e, r, t) {
        ...
        if (typeof Blob !== 'undefined') {
            var n = new Blob([V(a)], { type: 'application/octet-stream' });
    ...
    function xe(e, r, t) {
        if (e.FullPaths) j.utils.cfb_add(e, r, typeof t == 'string' ? (w ? k(t) : _(Ge(t))) : t);
        else e.file(r, t);
    }
    function Se(e, r) {
        var t;
        switch (r.type) {
            case 'base64':
                t = j.read(e, { type: 'base64' });
                break;
            case 'binary':
                t = j.read(e, { type: 'binary' });
                break;
            case 'buffer':
            case 'array':
                t = j.read(e, { type: 'buffer' });
                break;
            default:
        ...
        if (i)
            for (o = 0; o != i.length; ++o) {
                ...
                if (s === f.length) {
                    ...
                    var u = (s === 5 && f.slice(0, 5) === 'xmlns' ? 'xmlns' : '') + f.slice(s + 1);
                    if (t[u] && f.slice(s - 3, s) == 'ext') continue;
                    t[u] = l;
                    t[u.toLowerCase()] = l;
                }
            }
    ...
    if (w) {
        ...
        if (Xe(Je) == Ye(Je)) Xe = Ye;
        var qe = function Fl(e) {
            return k(e, 'binary').toString('utf8');
        };
        if (Xe(Je) == qe(Je)) Xe = qe;
        Ge = function(e) {
    ...
    var ar = /(^\s|\s$|\n)/;
    function nr(e, r) {
        return '<' + e + (r.match(ar) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e + '>';
    }
    function ir(e) {
        return Y(e)
            .map(function(r) {
    ...
    function sr(e, r, t) {
        return '<' + e + (t != null ? ir(t) : '') + (r != null ? (r.match(ar) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e : '/') + '>';
    }
    function lr(e, r) {
        try {
    ...
    function or(e) {
        switch (typeof e) {
            case 'string':
                return sr('vt:lpwstr', e);
            case 'number':
                return sr((e | 0) == e ? 'vt:i4' : 'vt:r8', String(e));
            case 'boolean':
                return sr('vt:bool', e ? 'true' : 'false');
        }
        if (e instanceof Date) return sr('vt:filetime', lr(e));
    ...
    fr.main = ['http://schemas.openxmlformats.org/spreadsheetml/2006/main', 'http://purl.oclc.org/ooxml/spreadsheetml/main', 'http://schemas.microsoft.com/office/excel/2006/main', 'http://schemas.microsoft.com/office/excel/2006/2'];
    var cr = {
    ...
    var Er = _r;
    var Fr, Ar;
    Fr = Ar = function Al(e, r) {
        var t = Lr(e, r);
        return t > 0 ? vr(e, r + 4, r + 4 + t) : '';
    };
    var Tr = function(e, r) {
        var t = Lr(e, r);
        return t > 0 ? wr(e, r + 4, r + 4 + t) : '';
    };
    var Or = Tr;
    var Dr, Mr;
    Dr = Mr = function(e, r) {
    ...
    if (w) {
        ...
        wr = function Nl(e, r, t) {
            return Buffer.isBuffer(e) ? e.toString('utf8', r, t) : kr(e, r, t);
        };
        dr = function(e) {
            return e[0].length > 0 && Buffer.isBuffer(e[0][0]) ? Buffer.concat(e[0]) : pr(e);
        };
        O = function(e) {
    ...
    function Wr(e, t) {
        ...
        switch (t) {
            ...
            case 'cstr':
                e = 0;
                a = '';
                while ((l = Rr(this, this.l + e++)) !== 0) s.push(p(l));
                a = s.join('');
                break;
            case '_wstr':
                e = 0;
                a = '';
                while ((l = Nr(this, this.l + e)) !== 0) {
                    s.push(p(l));
                    e += 2;
                }
                e += 2;
            ...
            case 'dbcs-cont':
                ...
                for (f = 0; f < e; ++f) {
                    if (this.lens && this.lens.indexOf(c) !== -1) {
                        l = Rr(this, c);
                        this.l = c + 1;
                        o = Wr.call(this, e - f, l ? 'dbcs-cont' : 'sbcs-cont');
                        return s.join('') + o;
                    }
                    s.push(p(Nr(this, c)));
                    c += 2;
            ...
            default:
                switch (e) {
                    case 1:
                        ...
                        return n;
                    case 2:
                        n = (t === 'i' ? Ir : Nr)(this, this.l);
                        this.l += 2;
                        return n;
                    case 4:
                    case -4:
                        if (t === 'i' || (this[this.l + 3] & 128) === 0) {
                            n = (e > 0 ? Br : zr)(this, this.l);
                            this.l += 4;
                            return n;
                        } else {
                            i = Lr(this, this.l);
    ...
    function Hr(e, r, t) {
        var a = 0,
            n = 0;
        if (t === 'dbcs') {
            for (n = 0; n != r.length; ++n) jr(this, r.charCodeAt(n), this.l + 2 * n);
            a = 2 * r.length;
        } else if (t === 'sbcs') {
    ...
    function rt(e, r) {
        if (e.s.r == 0 && !e.s.rRel) {
            if (e.e.r == (r.biff >= 12 ? 1048575 : r.biff >= 8 ? 65536 : 16384) && !e.e.rRel) {
                return (e.s.cRel ? '' : '$') + lt(e.s.c) + ':' + (e.e.cRel ? '' : '$') + lt(e.e.c);
            }
        }
        if (e.s.c == 0 && !e.s.cRel) {
        ...
        return et(e.s, r.biff) + ':' + et(e.e, r.biff);
    }
    function tt(e) {
    ...
    function mt(e, r) {
        ...
        try {
            return (e.w = P.format((e.XF || {}).numFmtId || (t ? 14 : 0), t ? re(r) : r));
        } catch (a) {
            return '' + r;
        }
    }
    ...
    var Rt = {
        ...
        11: { n: 'ScaleCrop', t: St },
        12: { n: 'HeadingPairs', t: Ot | Ct },
        13: { n: 'TitlesOfParts', t: Ot | Et },
        14: { n: 'Manager', t: Dt },
        15: { n: 'Company', t: Dt },
        ...
        24: { n: 'DigSig', t: At },
        26: { n: 'ContentType', t: Dt },
        27: { n: 'ContentStatus', t: Dt },
        28: { n: 'Language', t: Dt },
        29: { n: 'Version', t: Dt },
        255: {}
    };
    var Nt = {
        ...
        16: { n: 'CharCount', t: xt },
        17: { n: 'Thumbnail', t: Tt },
        18: { n: 'Application', t: Dt },
        19: { n: 'DocSecurity', t: xt },
        255: {}
    };
    var It = {
        2147483648: { n: 'Locale', t: _t },
        2147483651: { n: 'Behavior', t: _t },
        1919054434: {}
    };
    (function() {
        for (var e in It) if (It.hasOwnProperty(e)) Rt[e] = Nt[e] = It[e];
    })();
    var Lt = J(Rt, 'n');
    var Bt = J(Nt, 'n');
    var zt = {
    ...
    var Jt = [
        ...
        return sr('Default', null, { Extension: e[0], ContentType: e[1] });
    });
    function qt(e, r) {
        var t = [],
            a;
        ...
        var n = function(n) {
            if (e[n] && e[n].length > 0) {
                a = e[n][0];
                t[t.length] = sr('Override', null, {
                    PartName: (a[0] == '/' ? '' : '/') + a,
                    ContentType: Ht[n][r.bookType || 'xlsx']
                });
            }
        };
        var i = function(a) {
            (e[a] || []).forEach(function(e) {
                t[t.length] = sr('Override', null, {
                    PartName: (e[0] == '/' ? '' : '/') + e,
                    ContentType: Ht[a][r.bookType || 'xlsx']
                });
            });
        };
        var s = function(r) {
    ...
    function Qt(e, r) {
        ...
        (e.match(Ae) || []).forEach(function(e) {
            ...
            if (n[0] === '<Relationship') {
                ...
                var s = n.TargetMode === 'External' ? n.Target : _e(n.Target, r);
                t[s] = i;
                a[n.Id] = i;
            }
        });
    ...
    var ea = sr('Relationships', null, { xmlns: fr.RELS });
    function ra(e) {
        var r = [Ee, ea];
        Y(e['!id']).forEach(function(t) {
            r[r.length] = sr('Relationship', null, e['!id'][t]);
        });
        if (r.length > 2) {
    ...
    function ta(e, r, t, a, n) {
        ...
        n.Type = a;
        n.Target = t;
        if (n.Type == Zt.HLINK) n.TargetMode = 'External';
    ...
    Zt.CORE_PROPS = 'http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties';
    var na = (function() {
        var e = new Array(aa.length);
    ...
    var sa = sr('cp:coreProperties', null, {
    ...
    function oa(e, r) {
        ...
        if (e) {
            if (e.CreatedDate != null) la('dcterms:created', typeof e.CreatedDate === 'string' ? e.CreatedDate : lr(e.CreatedDate, t.WTF), { 'xsi:type': 'dcterms:W3CDTF' }, a, n);
            if (e.ModifiedDate != null) la('dcterms:modified', typeof e.ModifiedDate === 'string' ? e.ModifiedDate : lr(e.ModifiedDate, t.WTF), { 'xsi:type': 'dcterms:W3CDTF' }, a, n);
        }
    ...
    Zt.EXT_PROPS = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties';
    var ca = ['Worksheets', 'SheetNames', 'NamedRanges', 'DefinedNames', 'Chartsheets', 'ChartNames'];
    function ha(e, r, t, a) {
        var n = [];
        if (typeof e == 'string') n = tr(e, a);
        else
    ...
    function ua(e, r, t) {
        ...
        if (a.HeadingPairs && a.TitlesOfParts) ha(a.HeadingPairs, a.TitlesOfParts, r, t);
        return r;
    }
    var da = sr('Properties', null, { xmlns: fr.EXT_PROPS, 'xmlns:vt': fr.vt });
    function pa(e) {
        var r = [],
            t = sr;
        if (!e) e = {};
    ...
    var ga = sr('Properties', null, { xmlns: fr.CUST_PROPS, 'xmlns:vt': fr.vt });
    function ba(e) {
        var r = [Ee, ga];
        if (!e) return r.join('');
        var t = 1;
    ...
    var ka = /<(?:\w+:)?t[^>]*>([^<]*)<\/(?:\w+:)?t>/g,
        ya = /<(?:\w+:)?r>/;
    var xa = /<(?:\w+:)?rPh.*?>([\s\S]*?)<\/(?:\w+:)?rPh>/g;
    function Sa(e, r) {
        var t = r ? r.cellHTML : true;
        var a = {};
        if (!e) return null;
        if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
            a.t = Ne(Xe(e.slice(e.indexOf('>') + 1).split(/<\/(?:\w+:)?t>/)[0] || ''));
            a.r = Xe(e);
            if (t) a.h = $e(a.t);
        } else if (e.match(ya)) {
            a.r = Xe(e);
            a.t = Ne(Xe((e.replace(xa, '').match(ka) || []).join('').replace(Ae, '')));
            if (t) a.h = wa(a.r);
        }
        return a;
    }
    var Ca = /<(?:\w+:)?sst([^>]*)>([\s\S]*)<\/(?:\w+:)?sst>/;
    var _a = /<(?:\w+:)?(?:si|sstItem)>/g;
    var Ea = /<\/(?:\w+:)?(?:si|sstItem)>/;
    function Fa(e, r) {
        var t = [],
            a = '';
    ...
    Zt.SST = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings';
    var Aa = /^\s|\s$|[\t\n\r]/;
    function Ta(e, r) {
        if (!r.bookSST) return '';
        var t = [Ee];
        t[t.length] = sr('sst', null, {
            xmlns: fr.main[0],
            count: e.Count,
        ...
        for (var a = 0; a != e.length; ++a) {
            ...
            if (n.r) i += n.r;
                ...
                i += '<t';
                if (!n.t) n.t = '';
                if (n.t.match(Aa)) i += ' xml:space="preserve"';
                i += '>' + Be(n.t) + '</t>';
            }
            i += '</si>';
            t[t.length] = i;
    ...
    var Na = 6,
        ...
        Ba = Na;
    function za(e) {
        return Math.floor((e + Math.round(128 / Ba) / 256) * Ba);
    }
    function Wa(e) {
        return Math.floor(((e - 5) / Ba) * 100 + 0.5) / 100;
    }
    function $a(e) {
        return Math.round(((e * Ba + 5) / Ba) * 256) / 256;
    }
    function Ua(e) {
        return $a(Wa(za(e)));
    }
    function ja(e) {
        var r = Math.abs(e - Ua(e)),
            t = Ba;
        if (r > 0.005)
            for (Ba = La; Ba < Ia; ++Ba)
                if (Math.abs(e - Ua(e)) <= r) {
                    r = Math.abs(e - Ua(e));
                    t = Ba;
                }
        Ba = t;
        ...
        e[0].match(Ae).forEach(function(e) {
            ...
            switch (Me(l[0])) {
                ...
                case '<font/>':
                    ...
                    break;
                case '<name':
                    if (l.val) n.name = l.val;
                    break;
                case '<name/>':
                case '</name>':
                    break;
                case '<b':
                    n.bold = l.val ? Ve(l.val) : 1;
                    break;
                case '<b/>':
                    n.bold = 1;
                    break;
                case '<i':
                    n.italic = l.val ? Ve(l.val) : 1;
                    break;
                case '<i/>':
                    n.italic = 1;
                    break;
                ...
                case '<u/>':
                    ...
                    break;
                case '<strike':
                    n.strike = l.val ? Ve(l.val) : 1;
                    break;
                case '<strike/>':
                    n.strike = 1;
                    break;
                case '<outline':
                    n.outline = l.val ? Ve(l.val) : 1;
                    break;
                case '<outline/>':
                    n.outline = 1;
                    break;
                case '<shadow':
                    n.shadow = l.val ? Ve(l.val) : 1;
                    break;
                case '<shadow/>':
                    n.shadow = 1;
                    break;
                case '<condense':
                    n.condense = l.val ? Ve(l.val) : 1;
                    break;
                case '<condense/>':
                    n.condense = 1;
                    break;
                case '<extend':
                    n.extend = l.val ? Ve(l.val) : 1;
                    break;
                case '<extend/>':
                    n.extend = 1;
                    break;
                ...
                case '<color':
                    if (!n.color) n.color = {};
                    if (l.auto) n.color.auto = Ve(l.auto);
                    if (l.rgb) n.color.rgb = l.rgb.slice(-6);
                    else if (l.indexed) {
                        n.color.index = parseInt(l.indexed, 10);
                        var o = Ut[n.color.index];
                        if (n.color.index == 81) o = Ut[1];
                        ...
                        if (l.theme && t.themeElements && t.themeElements.clrScheme) {
                            n.color.rgb = Ra(t.themeElements.clrScheme[n.color.theme].rgb, n.color.tint || 0);
                        }
                    }
                    break;
                case '<color/>':
    ...
    function en(e) {
        ...
        r[r.length] = '</numFmts>';
        r[0] = sr('numFmts', null, { count: r.length - 2 }).replace('/>', '>');
        return r.join('');
    }
    var rn = ['numFmtId', 'fillId', 'fontId', 'borderId', 'xfId'];
    var tn = ['applyAlignment', 'applyBorder', 'applyFill', 'applyFont', 'applyNumberFormat', 'applyProtection', 'pivotButton', 'quotePrefix'];
    function an(e, r, t) {
        r.CellXf = [];
        var a;
        var n = false;
        e[0].match(Ae).forEach(function(e) {
            ...
            switch (Me(i[0])) {
                ...
                case '<xf/>':
                    a = i;
                    delete a[0];
                    for (s = 0; s < rn.length; ++s) if (a[rn[s]]) a[rn[s]] = parseInt(a[rn[s]], 10);
                    for (s = 0; s < tn.length; ++s) if (a[tn[s]]) a[tn[s]] = Ve(a[tn[s]]);
                    if (a.numFmtId > 392) {
                        for (s = 392; s > 60; --s)
                ...
                case '<alignment/>':
                    ...
                    if (i.wrapText) l.wrapText = i.wrapText;
                    a.alignment = l;
                    break;
                case '</alignment>':
                    break;
    ...
    function nn(e) {
        var r = [];
        r[r.length] = sr('cellXfs', null);
        e.forEach(function(e) {
            r[r.length] = sr('xf', null, e);
        });
        r[r.length] = '</cellXfs>';
        if (r.length === 2) return '';
        r[0] = sr('cellXfs', null, { count: r.length - 2 }).replace('/>', '>');
        return r.join('');
    }
    var sn = (function zl() {
        ...
        return function i(s, l, o) {
            ...
            var c;
            if ((c = s.match(e))) Qa(c, f, o);
            if ((c = s.match(a))) Ka(c, f, l, o);
            if ((c = s.match(t))) Za(c, f, l, o);
            if ((c = s.match(n))) qa(c, f, l, o);
            if ((c = s.match(r))) an(c, f, o);
            return f;
        };
    })();
    var ln = sr('styleSheet', null, { xmlns: fr.main[0], 'xmlns:vt': fr.vt });
    Zt.STY = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles';
    function on(e, r) {
        var t = [Ee, ln],
            a;
        if (e.SSF && (a = en(e.SSF)) != null) t[t.length] = a;
        ...
        if ((a = nn(r.cellXfs))) t[t.length] = a;
    ...
    Zt.THEME = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme';
    function fn(e, r, t) {
    ...
    function cn() {}
    function hn() {}
    var un = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
    var dn = /<a:fontScheme([^>]*)>[\s\S]*<\/a:fontScheme>/;
    var pn = /<a:fmtScheme([^>]*)>[\s\S]*<\/a:fmtScheme>/;
    function vn(e, r, t) {
        r.themeElements = {};
        var a;
        [
    ...
    Zt.IMG = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/image';
    Zt.DRAW = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/drawing';
    function yn(e, r) {
        if (!e) return '??';
    ...
    function Sn(e, r) {
        ...
        var n = [
            ...
            sr('o:shapelayout', sr('o:idmap', null, { 'v:ext': 'edit', data: e }), {
                'v:ext': 'edit'
            }),
            sr('v:shapetype', [sr('v:stroke', null, { joinstyle: 'miter' }), sr('v:path', null, { gradientshapeok: 't', 'o:connecttype': 'rect' })].join(''), { id: '_x0000_t202', 'o:spt': 202, coordsize: t.join(','), path: a })
        ];
        while (xn < e * 1e3) xn += 1e3;
        r.forEach(function(e) {
            ...
            n = n.concat([
                '<v:shape' +
                    ...
                    '>',
                sr('v:fill', sr('o:fill', null, { type: 'gradientUnscaled', 'v:ext': 'view' }), { color2: '#BEFF82', angle: '-180', type: 'gradient' }),
                sr('v:shadow', null, { on: 't', obscured: 't' }),
                sr('v:path', null, { 'o:connecttype': 'none' }),
                '<v:textbox><div style="text-align:left"></div></v:textbox>',
                '<x:ClientData ObjectType="Note">',
                '<x:MoveWithCells/>',
                '<x:SizeWithCells/>',
                nr('x:Anchor', [r.c, 0, r.r, 0, r.c + 3, 100, r.r + 5, 100].join(',')),
                nr('x:AutoFill', 'False'),
                nr('x:Row', String(r.r)),
                nr('x:Column', String(r.c)),
    ...
    Zt.CMNT = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments';
    function Cn(e, r, t, a, n) {
        for (var i = 0; i != r.length; ++i) {
            var s = r[i];
            var l = ss(we(e, s.replace(/^\//, ''), true), s, n);
    ...
    var Fn = sr('comments', null, { xmlns: fr.main[0] });
    function An(e) {
        var r = [Ee, Fn];
        var t = [];
        r.push('<authors>');
        ...
        e.forEach(function(e) {
            e[1].forEach(function(a) {
                r.push('<comment ref="' + e[0] + '" authorId="' + t.indexOf(Be(a.a)) + '"><text>');
                r.push(nr('t', a.t == null ? '' : Be(a.t)));
                r.push('</text></comment>');
            });
        });
        r.push('</commentList>');
    ...
    var Tn = 'application/vnd.ms-office.vbaProject';
    function On(e) {
        var r = j.utils.cfb_new({ root: 'R' });
    ...
    var Mn = ['xlsb', 'xlsm', 'xlam', 'biff8', 'xla'];
    Zt.DS = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/dialogsheet';
    Zt.MS = 'http://schemas.microsoft.com/office/2006/relationships/xlMacrosheet';
    function Pn() {
        return { '!type': 'dialog' };
    }
    function Rn() {
    ...
    var Bn = /(^|[^._A-Z0-9])([$]?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])([$]?)([1-9]\d{0,5}|10[0-3]\d{4}|104[0-7]\d{3}|1048[0-4]\d{2}|10485[0-6]\d|104857[0-6])(?![_.\(A-Za-z0-9])/g;
    var zn = (function() {
        return function e(r, t) {
            return r.replace(Bn, function(e, r, a, n, i, s) {
                var l = st(n) - (a ? 0 : t.c);
                var o = tt(s) - (i ? 0 : t.r);
                var f = o == 0 ? '' : !i ? '[' + o + ']' : o + 1;
                var c = l == 0 ? '' : !a ? '[' + l + ']' : l + 1;
    ...
    function Wn(e, r) {
        return e.replace(Bn, function(e, t, a, n, i, s) {
            return t + (a == '$' ? a + n : lt(st(n) + r.c)) + (i == '$' ? i + s : at(tt(s) + r.r));
        });
    }
    function $n(e, r, t) {
        var a = dt(r),
    ...
    var Hn = {};
    var Vn = {};
    Zt.WS = ['http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet', 'http://purl.oclc.org/ooxml/officeDocument/relationships/worksheet'];
    var Xn = typeof Map !== 'undefined';
    function Gn(e, r, t) {
        var a = 0,
            n = e.length;
        if (t) {
            if (Xn ? t.has(r) : t.hasOwnProperty(r)) {
                var i = Xn ? t.get(r) : t[r];
                for (; a < i.length; ++a) {
                    if (e[i[a]].t === r) {
                        e.Count++;
                        return i[a];
    ...
    function Zn(e, r, t, a, n, i) {
        ...
        if (!a || a.cellText !== false)
            try {
                if (P._table[r] == null) P.load(I[r] || 'General', r);
                if (e.t === 'e') e.w = e.w || BErr[e.v];
                else if (r === 0) {
                    if (e.t === 'n') {
                        ...
                        var l = re(e.v);
                        if ((l | 0) === l) e.w = P._general_int(l);
                        else e.w = P._general_num(l);
                    } else if (e.v === undefined) return '';
                    else e.w = P._general(e.v, Vn);
                } else if (e.t === 'd') e.w = P.format(r, re(e.v), Vn);
                else e.w = P.format(r, e.v, Vn);
            } catch (s) {
                if (a.WTF) throw s;
            }
        ...
        if (t != null)
            try {
                ...
                if (e.s.fgColor && e.s.fgColor.theme && !e.s.fgColor.rgb) {
                    e.s.fgColor.rgb = Ra(n.themeElements.clrScheme[e.s.fgColor.theme].rgb, e.s.fgColor.tint || 0);
                    if (a.WTF) e.s.fgColor.raw_rgb = n.themeElements.clrScheme[e.s.fgColor.theme].rgb;
                }
                if (e.s.bgColor && e.s.bgColor.theme) {
                    e.s.bgColor.rgb = Ra(n.themeElements.clrScheme[e.s.bgColor.theme].rgb, e.s.bgColor.tint || 0);
    ...
    function Qn(e, r) {
        var t = vt(r);
        if (t.s.r <= t.e.r && t.s.c <= t.e.c && t.s.r >= 0 && t.s.c >= 0) e['!ref'] = pt(t);
    }
    var ei = /<(?:\w:)?mergeCell ref="[A-Z0-9:]+"\s*[\/]?>/g;
    var ri = /<(?:\w+:)?sheetData>([\s\S]*)<\/(?:\w+:)?sheetData>/;
    var ti = /<(?:\w:)?hyperlink [^>]*>/gm;
    var ai = /"(\w*:\w*)"/;
    var ni = /<(?:\w:)?col\b[^>]*[\/]?>/g;
    var ii = /<(?:\w:)?autoFilter[^>]*([\/]|>([\s\S]*)<\/(?:\w:)?autoFilter)>/g;
    var si = /<(?:\w:)?pageMargins[^>]*\/>/g;
    var li = /<(?:\w:)?sheetPr\b(?:[^>a-z][^>]*)?\/>/;
    var oi = /<(?:\w:)?sheetViews[^>]*(?:[\/]|>([\s\S]*)<\/(?:\w:)?sheetViews)>/;
    function fi(e, r, t, a, n, i, s) {
        ...
        if (h) Ci(h[1], l, r, o, i, s);
        var w = c.match(ii);
        if (w) l['!autofilter'] = bi(w[0]);
        var k = [];
        var y = c.match(ei);
        if (y) for (d = 0; d != y.length; ++d) k[d] = vt(y[d].slice(y[d].indexOf('"') + 1));
        var x = c.match(ti);
        if (x) di(l, x, a);
        var S = c.match(si);
        if (S) l['!margins'] = pi(De(S[0]));
        if (!l['!ref'] && o.e.c >= o.s.c && o.e.r >= o.s.r) l['!ref'] = pt(o);
    ...
    function ci(e) {
        ...
        for (var t = 0; t != e.length; ++t) r += '<mergeCell ref="' + pt(e[t]) + '"/>';
        return r + '</mergeCells>';
    }
    function hi(e, r, t, a) {
        var n = De(e);
    ...
    function ui(e) {
        ...
        if (e.password)
            r.password = crypto_CreatePasswordVerifier_Method1(e.password)
                .toString(16)
                .toUpperCase();
        return sr('sheetProtection', null, r);
    }
    function di(e, r, t) {
        var a = Array.isArray(e);
        for (var n = 0; n != r.length; ++n) {
            var i = De(Xe(r[n]), true);
            if (!i.ref) return;
            var s = ((t || {})['!id'] || [])[i.id];
            if (s) {
                i.Target = s.Target;
            ...
            for (var o = l.s.r; o <= l.e.r; ++o)
                for (var f = l.s.c; f <= l.e.c; ++f) {
                    ...
                    if (a) {
                        if (!e[o]) e[o] = [];
                        if (!e[o][f]) e[o][f] = { t: 'z', v: undefined };
                        e[o][f].l = i;
                    } else {
    ...
    function wi(e, r, t, a) {
        ...
        return sr('autoFilter', null, { ref: n });
    }
    var ki = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/>/;
    function yi(e, r) {
        (e.match(ki) || []).forEach(function(e) {
            var t = De(e);
            if (Ve(t.rightToLeft)) {
                if (!r.Views) r.Views = [{}];
    ...
    function xi(e, r, t, a) {
        ...
        return sr('sheetViews', sr('sheetView', null, n), {});
    }
    function Si(e, r, t, a) {
        ...
        switch (e.t) {
            ...
            default:
                ...
                if (a.bookSST) {
                    l = nr('v', '' + Gn(a.Strings, e.v, a.revStrings));
                    o.t = 's';
                    break;
                }
                o.t = 'str';
    ...
    var Ci = (function() {
        ...
        return function l(o, f, c, h, u, d) {
            ...
            var I = [],
                L = {},
                B = false;
            for (var z = o.split(r), W = 0, $ = z.length; W != $; ++W) {
                v = z[W].trim();
                var U = v.length;
                if (U === 0) continue;
                for (p = 0; p < U; ++p) if (v.charCodeAt(p) === 62) break;
                ++p;
                ...
                for (p = 0; p != m.length; ++p) {
                    ...
                    if (!S.r) S.r = ut({ r: C - 1, c: _ });
                    y = v.slice(w);
                    x = { t: '' };
                    if ((g = y.match(i)) != null && g[1] !== '') x.v = Ne(g[1]);
                    if (c.cellFormula) {
                        if ((g = y.match(s)) != null && g[1] !== '') {
                            x.f = jn(Ne(Xe(g[1])));
                            if (g[0].indexOf('t="array"') > -1) {
                                x.F = (y.match(n) || [])[1];
                                if (x.F.indexOf(':') > -1) M.push([vt(x.F), x.F]);
                            } else if (g[0].indexOf('t="shared"') > -1) {
                                F = De(g[0]);
                                R[parseInt(F.si, 10)] = [F, jn(Ne(Xe(g[1]))), S.r];
                            }
                        } else if ((g = y.match(/<f[^>]*\/>/))) {
                            F = De(g[0]);
                            if (R[F.si]) x.f = $n(R[F.si][1], R[F.si][2], S.r);
                        }
                        var j = ht(S.r);
                        for (w = 0; w < M.length; ++w) if (j.r >= M[w][0].s.r && j.r <= M[w][0].e.r) if (j.c >= M[w][0].s.c && j.c <= M[w][0].e.c) x.F = M[w][1];
                    }
                    ...
                    switch (x.t) {
                        ...
                        case 's':
                            if (typeof x.v == 'undefined') {
                                ...
                                E = Hn[parseInt(x.v, 10)];
                                x.v = E.t;
                                x.r = E.r;
                                if (c.cellHTML) x.h = E.h;
                            }
                            break;
                        case 'str':
                            x.t = 's';
                            x.v = x.v != null ? Xe(x.v) : '';
                            if (c.cellHTML) x.h = $e(x.v);
                            break;
                        case 'inlineStr':
                            g = y.match(a);
                            x.t = 's';
                            if (g != null && (E = Sa(g[1]))) x.v = E.t;
                            else x.v = '';
                            break;
                        case 'b':
                            x.v = Ve(x.v);
                    ...
                    Zn(x, A, T, c, u, d);
                    if (c.cellDates && O && x.t == 'n' && P.is_date(P._table[A])) {
                        x.t = 'd';
                        x.v = te(x.v);
                    }
                    if (N) {
    ...
    function _i(e, r, t, a) {
        ...
        for (h = s.s.r; h <= s.e.r; ++h) {
            ...
            for (u = s.s.c; u <= s.e.c; ++u) {
                ...
                if ((l = Si(b, o, e, r, t, a)) != null) i.push(l);
            }
            if (i.length > 0 || (d && d[h])) {
                v = { r: f };
                if (d && d[h]) {
    ...
    var Ei = sr('worksheet', null, { xmlns: fr.main[0], 'xmlns:r': fr.r });
    function Fi(e, r, t, a) {
        var n = [Ee, Ei];
        ...
        if (r.bookType !== 'xlsx' && t.vbaraw) {
            ...
            n[n.length] = sr('sheetPr', null, { codeName: Be(h) });
        }
        n[n.length] = sr('dimension', null, { ref: f });
        n[n.length] = xi(o, r, e, t);
        if (r.sheetFormat)
            n[n.length] = sr('sheetFormatPr', null, {
        ...
        if (o['!cols'] != null && o['!cols'].length > 0) n[n.length] = gi(o, o['!cols']);
        ...
        if (o['!protect'] != null) n[n.length] = ui(o['!protect']);
        if (o['!autofilter'] != null) n[n.length] = wi(o['!autofilter'], o, t, e);
        ...
        if (o['!links'].length > 0) {
            ...
            o['!links'].forEach(function(e) {
                ...
                if (e[1].Target.charAt(0) != '#') {
                    v = ta(a, -1, Be(e[1].Target).replace(/#.*$/, ''), Zt.HLINK);
                    p['r:id'] = 'rId' + v;
                }
                if ((d = e[1].Target.indexOf('#')) > -1) p.location = Be(e[1].Target.slice(d + 1));
                if (e[1].Tooltip) p.tooltip = Be(e[1].Tooltip);
                n[n.length] = sr('hyperlink', null, p);
            });
            n[n.length] = '</hyperlinks>';
        }
        delete o['!links'];
        if (o['!margins'] != null) n[n.length] = vi(o['!margins']);
        n[n.length] = '';
        if (!r || r.ignoreEC || r.ignoreEC == void 0) n[n.length] = nr('ignoredErrors', sr('ignoredError', null, { numberStoredAsText: 1, sqref: f }));
        if (o['!drawing'].length > 0) {
            v = ta(a, -1, '../drawings/drawing' + (e + 1) + '.xml', Zt.DRAW);
            n[n.length] = sr('drawing', null, { 'r:id': 'rId' + v });
        } else delete o['!drawing'];
        if (o['!comments'].length > 0) {
            v = ta(a, -1, '../drawings/vmlDrawing' + (e + 1) + '.vml', Zt.VML);
            n[n.length] = sr('legacyDrawing', null, { 'r:id': 'rId' + v });
            o['!legacy'] = v;
        }
        if (n.length > 2) {
    ...
    Zt.CS = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/chartsheet';
    var Oi = sr('chartsheet', null, { xmlns: fr.main[0], 'xmlns:r': fr.r });
    ...
    function Mi(e, r, t, a) {
        var n = [Ee, Oi];
        n[n.length] = sr('drawing', null, { 'r:id': 'rId1' });
        ta(a, -1, '../drawings/drawing' + (e + 1) + '.xml', Zt.DRAW);
        if (n.length > 2) {
            ...
            function o(e, a, f) {
                switch (f) {
                    ...
                    default:
                        ...
                        else if (!l || r.WTF) throw new Error('Unexpected record ' + f + ' ' + a);
                }
            },
            r
        );
    ...
    function Ui(e) {
        ...
        Wi(e.WBView, Li);
        Wi(e.Sheets, Bi);
        Vn.date1904 = Ve(e.WBProps.date1904);
    }
    function ji(e) {
    ...
    function Gi(e) {
        ...
        Xi(e.SheetNames, r, !!e.vbaraw);
        for (var t = 0; t < e.SheetNames.length; ++t) Kn(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
    }
    var Yi = /<\w+:workbook/;
    function Ji(e, r) {
        ...
        var i = {},
            s = 0;
        e.replace(Ae, function l(o, f) {
            var c = De(o);
            switch (Me(c[0])) {
                case '<?xml':
                    break;
                case '<workbook':
                    if (o.match(Yi)) n = 'xmlns' + o.match(/<(\w+):/)[1];
                    t.xmlns = c[n];
                    break;
                case '</workbook>':
                    break;
    ...
    var qi = sr('workbook', null, { xmlns: fr.main[0], 'xmlns:r': fr.r });
    function Zi(e) {
        var r = [Ee];
        r[r.length] = qi;
        ...
        r[r.length] = sr('workbookPr', null, a);
    ...
    function Qi(e, r, t, a, n, i, s, l) {
        if (r.slice(-4) === '.bin') return parse_ws_bin(e, a, t, n, i, s, l);
        return fi(e, a, t, n, i, s, l);
    }
    function es(e, r, t, a, n, i, s, l) {
        if (r.slice(-4) === '.bin') return Ri(e, a, t, n, i, s, l);
        return Di(e, a, t, n, i, s, l);
    }
    function rs(e, r, t, a, n, i, s, l) {
        if (r.slice(-4) === '.bin') return Nn(e, a, t, n, i, s, l);
        return In(e, a, t, n, i, s, l);
    }
    function ts(e, r, t, a, n, i, s, l) {
        if (r.slice(-4) === '.bin') return Pn(e, a, t, n, i, s, l);
        return Rn(e, a, t, n, i, s, l);
    }
    function as(e, r, t, a) {
    ...
    function os(e, r, t) {
        if (r.slice(-4) === '.bin') return kn(e, r, t);
        return wn(e, r, t);
    }
    function fs(e, r, t) {
        return (r.slice(-4) === '.bin' ? write_wb_bin : Zi)(e, t);
    }
    function cs(e, r, t, a, n) {
        return (r.slice(-4) === '.bin' ? write_ws_bin : Fi)(e, t, a, n);
    }
    function hs(e, r, t, a, n) {
        return (r.slice(-4) === '.bin' ? Ni : Mi)(e, t, a, n);
    }
    function us(e, r, t) {
        return (r.slice(-4) === '.bin' ? write_sty_bin : on)(e, t);
    }
    function ds(e, r, t) {
        return (r.slice(-4) === '.bin' ? write_sst_bin : Ta)(e, t);
    }
    function ps(e, r, t) {
        return (r.slice(-4) === '.bin' ? write_comments_bin : An)(e, t);
    }
    var vs = (function() {
        function e(e, r) {
            var t = r || {};
            ...
            for (s = 0; s < o.length; ++s) {
                ...
                for (l = 0; l < b.length; ++l) {
                    ...
                    var x = De(w.slice(0, w.indexOf('>')));
                    u = x.colspan ? +x.colspan : 1;
                    if ((h = +x.rowspan) > 1 || u > 1)
                        p.push({
                            s: { r: f, c: c },
                            e: { r: f + (h || 1) - 1, c: c + u - 1 }
                        });
                    ...
                    var C = { t: 's', v: k };
                    if (t.raw || !k.trim().length || S == 's') {
                    } else if (k === 'TRUE') C = { t: 'b', v: true };
                    else if (k === 'FALSE') C = { t: 'b', v: false };
                    else if (!isNaN(ce(k))) C = { t: 'n', v: ce(k) };
                    else if (!isNaN(he(k).getDate())) {
                        C = { t: 'd', v: se(k) };
                        if (!t.cellDates) C = { t: 'n', v: re(C.v) };
                        C.z = t.dateNF || P._table[14];
                    }
                    if (t.dense) {
                        if (!a[f]) a[f] = [];
                        a[f][c] = C;
        ...
        function t(e, r, t, a) {
            ...
            for (var s = r.s.c; s <= r.e.c; ++s) {
                ...
                if (l > 1) u.rowspan = l;
                if (o > 1) u.colspan = o;
                var d = (h && h.v != null && (h.h || $e(h.w || (gt(h), h.w) || ''))) || '';
                u.t = (h && h.t) || 'z';
        ...
        function s(e, r) {
            ...
            f.push(a(e, c, s));
            for (var h = c.s.r; h <= c.e.r; ++h) f.push(t(e, c, h, s));
            f.push('</table>' + o);
            return f.join('');
        }
        return {
    ...
    function ms(e, r) {
        ...
        for (; c < n.length && h < i; ++c) {
            ...
            for (u = d = 0; u < b.length; ++u) {
                var w = b[u];
                if (t.display && bs(w)) continue;
                var k = Ke(w.innerHTML);
                for (o = 0; o < l.length; ++o) {
                    var y = l[o];
                    if (y.s.c == d && y.s.r <= h && h <= y.e.r) {
                        d = y.e.c + 1;
                        o = -1;
                    }
                }
                ...
                if (k != null) {
                    if (k.length == 0) x.t = S || 'z';
                    else if (t.raw || k.trim().length == 0 || S == 's') {
                    } else if (k === 'TRUE') x = { t: 'b', v: true };
                    else if (k === 'FALSE') x = { t: 'b', v: false };
                    else if (!isNaN(ce(k))) x = { t: 'n', v: ce(k) };
                    else if (!isNaN(he(k).getDate())) {
                        x = { t: 'd', v: se(k) };
                        if (!t.cellDates) x = { t: 'n', v: re(x.v) };
                        x.z = t.dateNF || P._table[14];
                    }
                }
                if (t.dense) {
                    if (!a[h]) a[h] = [];
        ...
        if (l.length) a['!merges'] = l;
        if (f.length) a['!rows'] = f;
        s.e.r = h - 1;
        a['!ref'] = pt(s);
    ...
    var xs = ys(vs);
    var Ss = ys({ from_sheet: hl });
    var Cs = ys(typeof SYLK !== 'undefined' ? SYLK : {});
    var _s = ys(typeof DIF !== 'undefined' ? DIF : {});
    var Es = ys(typeof PRN !== 'undefined' ? PRN : {});
    var Fs = ys(typeof RTF !== 'undefined' ? RTF : {});
    var As = ys({ from_sheet: ul });
    var Ts = ys(typeof DBF !== 'undefined' ? DBF : {});
    var Os = ys(typeof ETH !== 'undefined' ? ETH : {});
    function Ds(e) {
        return function r(t) {
            for (var a = 0; a != e.length; ++a) {
                var n = e[a];
    ...
    function Rs(e) {
        if (Zt.WS.indexOf(e) > -1) return 'sheet';
        if (Zt.CS && e == Zt.CS) return 'chart';
        if (Zt.DS && e == Zt.DS) return 'dialog';
        if (Zt.MS && e == Zt.MS) return 'macro';
    ...
    function Ns(e, r) {
        ...
        try {
            e = r.map(function a(r) {
                ...
                return [r.name, e['!id'][r.id].Target, Rs(e['!id'][r.id].Type)];
            });
        } catch (t) {
            return null;
        }
    ...
    function Is(e, r, t, a, n, i, s, l, o, f, c, h) {
        try {
            i[a] = Qt(ke(e, t, true), r);
            var u = we(e, r);
            var d;
            switch (l) {
                case 'sheet':
                    d = Qi(u, r, n, o, i[a], f, c, h);
                    break;
                case 'chart':
                    d = es(u, r, n, o, i[a], f, c, h);
                    if (!d || !d['!chart']) break;
                    var p = _e(d['!chart'].Target, r);
                    var v = Kt(p);
                    var m = yn(ke(e, p, true), Qt(ke(e, v, true), p));
                    var g = _e(m, p);
                    var b = Kt(g);
                    d = Ti(ke(e, g, true), g, o, Qt(ke(e, b, true), g), f, d);
                    break;
                case 'macro':
                    d = rs(u, r, n, o, i[a], f, c, h);
                    break;
                case 'dialog':
                    d = ts(u, r, n, o, i[a], f, c, h);
                    break;
            }
            s[a] = d;
        } catch (w) {
    ...
    function Bs(e, r) {
        ...
        r = r || {};
        Ms(r);
        if (ge(e, 'META-INF/manifest.xml')) return parse_ods(e, r);
        if (ge(e, 'objectdata.xml')) return parse_ods(e, r);
        if (ge(e, 'Index/Document.iwa')) throw new Error('Unsupported NUMBERS file');
        var t = ye(e);
        var a = Gt(ke(e, '[Content_Types].xml'));
        var n = false;
        var i, s;
        ...
        if (!r.bookSheets && !r.bookProps) {
            ...
            if (a.sst)
                try {
                    Hn = is(we(e, Ls(a.sst)), a.sst, r);
                } catch (f) {
                    if (r.WTF) throw f;
                }
            if (r.cellStyles && a.themes.length) l = ns(ke(e, a.themes[0].replace(/^\//, ''), true) || '', a.themes[0], r);
            if (a.style) o = as(we(e, Ls(a.style)), a.style, l, r);
        }
        a.links.map(function(t) {
            return os(we(e, Ls(t)), t, r);
        });
        var c = Ki(we(e, Ls(a.workbooks[0])), a.workbooks[0], r);
        var h = {},
            u = '';
        if (a.coreprops.length) {
            u = we(e, Ls(a.coreprops[0]), true);
            if (u) h = ia(u);
            if (a.extprops.length !== 0) {
                u = we(e, Ls(a.extprops[0]), true);
                if (u) ua(u, h, r);
            }
        }
        var d = {};
        ...
        i = {};
        var v = {};
        if (r.bookDeps && a.calcchain) v = ls(we(e, Ls(a.calcchain)), a.calcchain, r);
        var m = 0;
        var g = {};
        var b, w;
        {
        ...
        var C = (a.workbooks[0].slice(0, S + 1) + '_rels/' + a.workbooks[0].slice(S + 1) + '.rels').replace(/^\//, '');
        if (!ge(e, C)) C = 'xl/_rels/workbook.' + x + '.rels';
        var _ = Qt(ke(e, C, true), C);
        if (_) _ = Ns(_, c.Sheets);
        var E = we(e, 'xl/worksheets/sheet.xml', true) ? 1 : 0;
        for (m = 0; m != h.Worksheets; ++m) {
            var F = 'sheet';
            if (_ && _[m]) {
                b = 'xl/' + _[m][1].replace(/[\/]?xl\//, '');
                if (!ge(e, b)) b = _[m][1];
                if (!ge(e, b)) b = C.replace(/_rels\/.*$/, '') + _[m][1];
                F = _[m][2];
            } else {
                b = 'xl/worksheets/sheet' + (m + 1 - E) + '.' + x;
                b = b.replace(/sheet0\./, 'sheet.');
            }
            w = b.replace(/^(.*)(\/)([^\/]*)$/, '$1/_rels/$3.rels');
            Is(e, b, w, h.SheetNames[m], m, g, i, F, r, c, l, o);
        }
        if (a.comments) Cn(e, a.comments, i, g, r);
        p = {
            Directory: a,
            Workbook: c,
            Props: h,
        ...
        if (r.bookVBA) {
            if (a.vba.length > 0) p.vbaraw = we(e, Ls(a.vba[0]), true);
            else if (a.defaults && a.defaults.bin === Tn) p.vbaraw = we(e, 'xl/vbaProject.bin', true);
        }
        return p;
    }
    function zs(e, r) {
    ...
    function Ws(e, r) {
        ...
        for (l = 1; l <= e.SheetNames.length; ++l) {
            ...
            switch (u) {
                ...
                default:
                    ...
                    xe(i, s, cs(l - 1, s, r, e, c));
                    n.sheets.push(s);
                    ta(r.wbrels, -1, 'worksheets/sheet' + l + '.' + t, Zt.WS[0]);
            }
            if (h) {
                var d = h['!comments'];
                var p = false;
                if (d && d.length > 0) {
                    ...
                    xe(i, v, ps(d, v, r));
                    n.comments.push(v);
                    ta(c, -1, '../comments' + l + '.' + t, Zt.CMNT);
                    p = true;
                }
                if (h['!legacy']) {
                    if (p) xe(i, 'xl/drawings/vmlDrawing' + l + '.vml', Sn(l, h['!comments']));
                }
                delete h['!comments'];
                delete h['!legacy'];
            }
            if (c['!id'].rId1) xe(i, Kt(s), ra(c));
        }
        if (r.Strings != null && r.Strings.length > 0) {
            s = 'xl/sharedStrings.' + t;
            xe(i, s, ds(r.Strings, s, r));
            n.strs.push(s);
            ta(r.wbrels, -1, 'sharedStrings.' + t, Zt.SST);
        }
        s = 'xl/workbook.' + t;
        xe(i, s, fs(e, s, r));
        n.workbooks.push(s);
        ...
        xe(i, s, bn(e.Themes, r));
        n.themes.push(s);
        ta(r.wbrels, -1, 'theme/theme1.xml', Zt.THEME);
        s = 'xl/styles.' + t;
        xe(i, s, us(e, s, r));
        n.styles.push(s);
        ta(r.wbrels, -1, 'styles.' + t, Zt.STY);
        if (e.vbaraw && a) {
            s = 'xl/vbaProject.bin';
            xe(i, s, e.vbaraw);
            n.vba.push(s);
            ta(r.wbrels, -1, 'vbaProject.bin', Zt.VBA);
        }
        xe(i, '[Content_Types].xml', qt(n, r));
        xe(i, '_rels/.rels', ra(r.rels));
        xe(i, 'xl/_rels/workbook.' + t + '.rels', ra(r.wbrels));
        delete r.revssf;
        delete r.ssf;
        return i;
    }
    ...
    function Us(e, r) {
        if (j.find(e, 'EncryptedPackage')) return zs(e, r);
    ...
    function Ys(e, r, t, a) {
        ...
        return PRN.to_workbook(r, t);
    }
    function Js(e, r) {
        f();
        if (typeof ArrayBuffer !== 'undefined' && e instanceof ArrayBuffer) return Js(new Uint8Array(e), r);
        var t = e,
            a = [0, 0, 0, 0],
            n = false;
        var i = r || {};
        Vn = {};
        if (i.dateNF) Vn.dateNF = i.dateNF;
        ...
        switch ((a = $s(t, i))[0]) {
            case 208:
                return Us(j.read(t, i), i);
            case 9:
                return parse_xlscfb(t, i);
            case 60:
                return parse_xlml(t, i);
            case 73:
                if (a[1] === 68) return read_wb_ID(t, i);
                break;
            case 84:
                if (a[1] === 65 && a[2] === 66 && a[3] === 76) return DIF.to_workbook(t, i);
                break;
            case 80:
                return a[1] === 75 && a[2] < 9 && a[3] < 9 ? js(t, i) : Ys(e, t, i, n);
            case 239:
                return a[3] === 60 ? parse_xlml(t, i) : Ys(e, t, i, n);
            case 255:
                if (a[1] === 254) {
                    return Xs(t, i);
                }
        ...
        if (a[2] <= 12 && a[3] <= 31) return DBF.to_workbook(t, i);
        return Ys(e, t, i, n);
    }
    function qs(e, r) {
        var t = r || {};
    ...
    function Zs(e, r) {
        switch (r.type) {
            ...
            case 'array':
                ...
                break;
            case 'file':
                return X(r.file, j.write(e, { type: w ? 'buffer' : '' }));
            case 'string':
    ...
    function Ks(e, r) {
        ...
        var i = a.FullPaths
            ...
            : a.generate(n);
        if (t.password && typeof encrypt_agile !== 'undefined') return Zs(encrypt_agile(i, t.password), t);
    ...
    function tl(e, r) {
        switch (r.type) {
            ...
            case 'binary':
                ...
                return r.type == 'base64' ? b.encode(t) : r.type == 'string' ? Xe(t) : t;
            case 'file':
                return X(r.file, e);
            case 'buffer':
                return e;
    ...
    function sl(e, r, t, a) {
        ...
        return H.writeFile(e, al(r, n), i);
    }
    function ll(e, r, t, a, n, i, s, l) {
        var o = at(t);
        var f = l.defval,
            c = l.raw || !l.hasOwnProperty('raw');
        var h = true;
        var u = n === 1 ? [] : {};
        if (n !== 1) {
        ...
        for (b = o.s.c; b <= o.e.c; ++b) {
            ...
            switch (a) {
                ...
                default:
                    ...
                    l = s = gt(t, null, f);
                    v = 0;
                    for (w = 0; w < i.length; ++w) if (i[w] == l) l = s + '_' + ++v;
                    i[b] = l;
            }
        }
        for (g = o.s.r + n; g <= o.e.r; ++g) {
            var k = ll(e, o, g, u, a, i, m, f);
    ...
    function hl(e, r) {
        ...
        for (var p = n.s.c; p <= n.e.c; ++p) if (!(u[p] || {}).hidden) h[p] = lt(p);
        for (var v = n.s.r; v <= n.e.r; ++v) {
            if ((d[v] || {}).hidden) continue;
            c = cl(e, n, v, h, s, o, i, a);
            if (c == null) {
                continue;
            }
    ...
    function dl(e) {
        ...
        for (l = n.s.c; l <= n.e.c; ++l) s[l] = lt(l);
    ...
    function pl(e, r, t) {
        ...
        var p = at(s);
        if (n) for (d = 0; d < u.length; ++d) i[lt(d + l) + p] = { t: 's', v: u[d] };
        i['!ref'] = pt(c);
        return i;
    }
    function vl(e, r) {
